...
/**
 * CodeIgniter
 * download ulang di arig 2018-09-06
 * http://trac.cae.tntech.edu/time/browser/system/database/drivers/oci8/oci8_forge.php?rev=10&desc=1
...
class CI_DB_oci8_driver extends CI_DB {
        ...
        function _execute_eon_ora($sql) {
                // arig 2020-12-14
                $this->stmt_id = FALSE;
                $this->_set_stmt_id($sql);
                ocisetprefetch($this->stmt_id, 1000);
                @oci_execute($this->stmt_id, $this->_commit);
                $result = oci_error($this->stmt_id);
                return $result;
        }
        ...
        function stored_procedure($package, $procedure, $params)
        {
                ...
                $sql = trim($sql, ",") . "); end;";
                //log_message('info', "3333333333333333 stored_procedure : ".$sql);//arig tes 2020.09.05
                $this->stmt_id = FALSE;
                $this->_set_stmt_id($sql);
        ...
        function count_all($table = '')
        {
                ...
                return (int) $row->NUMROWS;  // ARIG ORACLE SELALU DALAM HURUF BESAR
        }
        // --------------------------------------------------------------------
        /**
         * Show table query
         ...
         * ARIG 2018-09-19
         */
        protected function _insert_batch_ora($table, $keys, $values)
        {
                $keys = implode(', ', $keys);
                $sql = "INSERT ALL\n";

...
class CI_DB_postgre_driver extends CI_DB {
    ...
    function _execute_eon_pgs($sql) {
            ...
            return $result;
            */
			log_message('info', "ccccccccccccccccccccccccccccc  _execute_eon_pgs : " . $sql);
			$sql = $this->_prep_query($sql);
			log_message('info', "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA  _execute_eon_pgs : " . $sql);
			$result = @pg_query($this->conn_id, $sql);
			log_message('info', "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx  _execute_eon_pgs : " . $result);
			return $result;
    }

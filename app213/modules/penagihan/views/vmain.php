...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Dashboard Module Distribusi SPPT</h4>
    		...
    		<div class="back_rest">
    		  <center>
      			<h2 style="color:#FFF">PEMERINTAH DAERAH <?php //echo LICENSE_TO_SUB?></h2>
      			<h3 style="color:#FFF"><?php echo LICENSE_TO?></h3><br />
      			<img src="<?php echo app_img_logo('assets/img/img_logo3.png')?>" alt="logo" style="max-height:250px;"><br />

      			<!--<h2>Modul Retribusi Jasa Pemanfaatan Kekayaan Daerah</h2> -->
      			<!--<P>Module ini digunakan untuk mengelola data Kekayaan Daerah</P>-->
      			<br /><br /><br /><P><i class="icon-star"></i> SELAMAT BEKERJA <i class="icon-star"></i></P>
    			</center>
    		</div>

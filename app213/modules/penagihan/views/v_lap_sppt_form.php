                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input class="input form-control" type="hidden" style="margin-right: 5px;" name="prm_awal_ptgs" id="prm_awal_ptgs" value="<?php echo $dt['prm_awal_ptgs']?>" />
                            <input class="input form-control" type="hidden" style="margin-right: 5px;" name="prm_awal_tgl_fr" id="prm_awal_tgl_fr" value="<?php echo $dt['prm_awal_tgl_fr']?>" />
                            <input class="input form-control" type="hidden" style="margin-right: 5px;" name="prm_awal_tgl_to" id="prm_awal_tgl_to" value="<?php echo $dt['prm_awal_tgl_to']?>" />
                            <input class="input form-control" type="hidden" style="margin-right: 5px;" name="prm_awal_sts_verif" id="prm_awal_sts_verif" value="<?php echo $dt['prm_awal_sts_verif']?>" />
                            ...
                            <div class="row">
                                <div class="col-md-8">  <!-- DATA AWAL -->
                                    ...
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">No Telepon</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="tlp" id="tlp" value="<?php echo $dt['tlp']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="email" id="email" value="<?php echo $dt['email']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">Golongan Tarif Listrik</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="golongan_listrik" id="golongan_listrik" value="<?php echo $dt['golongan_listrik']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">Batasan Daya</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="batasan_daya" id="batasan_daya" value="<?php echo $dt['batasan_daya']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">No Plat Kendaraan Roda 2</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="plat_2" id="plat_2" value="<?php echo $dt['plat_2']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">No Plat Kendaraan Roda 4</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="plat_4" id="plat_4" value="<?php echo $dt['plat_4']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">Nama Penerima</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="nama_penerima" id="nama_penerima" value="<?php echo $dt['nama_penerima']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">Status Penerima</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="sts_penerima" id="sts_penerima" value="<?php echo $dt['sts_penerima']?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
...
var oTable;
    ...
    $(document).ready(function () {
        window.history.replaceState({}, "", "<?php echo active_module_url();?>lap_sppt/detail/<?php echo $dt['nop']?>");
        ...
        $("[id=btn_batal]").click(function(){
            ...
            var ptgs = $('#prm_awal_ptgs').val();
            var tgl_fr = $('#prm_awal_tgl_fr').val();
            var tgl_to = $('#prm_awal_tgl_to').val();
            ...
            window.location = '<?php echo active_module_url();?>lap_sppt/?'+data_params;

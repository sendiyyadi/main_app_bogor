            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">PROSES PEMBETULAN ALAMAT SPPT</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Distribusi SPPT</a>
                                </li>
                                <li class="breadcrumb-item active">Proses Pembetulan Alamat SPPT</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">  <!-- DATA AWAL -->
                                    ...
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">Luas Bumi</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="luas_bumi_op_a" id="luas_bumi_op_a" value="<?php echo $dt[LUAS_BUMI_OLD_DSP]?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">Luas Bangunan</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="luas_bng_a" id="luas_bng_a" value="<?php echo $dt[LUAS_BNG_OLD_DSP]?>" readonly />
                                        </div>
                                    </div>
                                ...
                                <div class="row control-group" style="margin-bottom:5px">
                                    ...
                                    <div class="row control-group" style="margin-bottom:5px">
                                        ...
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="luas_bumi_op_b" id="luas_bumi_op_b" value="<?php echo $dt[LUAS_BUMI_NEW_DSP]?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <input class="input form-control" type="text" style="margin-right: 5px;" name="luas_bng_b" id="luas_bng_b" value="<?php echo $dt[LUAS_BNG_NEW_DSP]?>" readonly />
                                        </div>
                                    </div>
                                    <div class="row control-group" style="margin-bottom:5px">
                                        <div class="col-md-3">
                                            <label class="control-label" style="vertical-align:sub">Foto Pembetulan</label>
                                        </div>
                                        <div class="col-md-8">
                                          <?php //echo $dt[GMBRTT12] ?>
                                          <?php if ($dt[GMBRTT12] == 1): ?>
                                            <!-- <a target="_blank" href="<?php //echo active_module_url().'pembetulan_sppt/openblob/FOTO_PEMBETULAN/'.$dt[NOP_DSP].'/'.$dt[THN_PAJAK_SPPT_DSP]; ?>" class="btn btn-primary " data-toggle="tooltip" title="View"></i> Lihat File</a> -->
                                            <?php //echo URL_API_SPPT_NEO.$dt['gmbr'] ?>
                                            <!-- <a target="_blank" href="<?php //echo URL_API_SPPT_NEO.$dt['gmbr']; ?>" class="btn btn-primary " data-toggle="tooltip" title="View"></i> Lihat File</a> -->
                                            <!-- <img src='<?php echo URL_API_SPPT_NEO.$dt['gmbr'] ?>' width='500'> -->
                                            <a target="_blank" href="<?php echo URL_API_SPPT_NEO.$dt['gmbr']; ?>" class="btn btn-primary " data-toggle="tooltip" title="View"></i> Lihat File</a>
                                          <?php else: ?>
...
var oTable;
    ...
    $(document).ready(function () {
        ...
        window.history.replaceState({}, "", "<?php echo active_module_url();?>pembetulan_sppt/detail/<?php echo $dt[ID_DSP]?>");
        ...
        $("[id=btn_batal]").click(function(){
            ...
            window.location = '<?php echo active_module_url();?>pembetulan_sppt/?'+data_params;
        ...
        $("[id=btn_tolak]").click(function(){
            ...
            var data_params = decodeURIComponent($.param(params));
            // alert(id);
            window.location = '<?php echo active_module_url();?>pembetulan_sppt/process_tolak/'+id+'/?'+data_params;
        });

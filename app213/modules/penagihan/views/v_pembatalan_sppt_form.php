...
var oTable;
    ...
    $(document).ready(function () {
        window.history.replaceState({}, "", "<?php echo active_module_url();?>pembatalan_sppt/detail/<?php echo $dt['nop']?>");
        ...
        $("[id=btn_batal]").click(function(){
            ...
            window.location = '<?php echo active_module_url();?>pembatalan_sppt/?'+data_params;

...
var oTable;
    ...
    $(document).ready(function () {
        window.history.replaceState({}, "", "<?php echo active_module_url();?>proses_laporan/detail/<?php echo $dt['nop']?>");
        ...
        $("[id=btn_batal]").click(function(){
            ...
            window.location = '<?php echo active_module_url();?>proses_laporan/?'+data_params;

                    ...
                    <div id="gap_form">
                      ...
                      <div class="row" style="margin-bottom:5px">
                          ...
                          <div class="col-md-4">
                              ...
                              <button class="btn btn-danger" id="btn_cetak">CETAK</button>
                          </div>
                      </div>
                    </div>
...
function reload_grid() {
  ...
  oTable.fnReloadAjax("<?php echo active_module_url();?>approve_pembatalan/grid/?"+data_params);
...
function get_kelurahan(kec_id) {
	$.ajax({
		url: "<?php echo active_module_url()?>approve_pembatalan/get_kelurahan/"+kec_id,
		success: function (j) {
...
var oTable;
    ...
    $(document).ready(function () {
        window.history.replaceState({}, "", "<?php echo active_module_url();?>approve_pembatalan/");
        ...
        oTable = $('#mytable').dataTable({
          ...
          // "sAjaxSource": "<?php echo active_module_url();?>Pembetulan_sppt/grid/?sts=9"
      		"sAjaxSource": "<?php echo active_module_url();?>approve_pembatalan/grid/?"+data_params_awal
      	});
        ...
        $("[id=btn_approve]").click(function(){
          if(ID){
                window.location = '<?php echo active_module_url();?>approve_pembatalan/approve/'+ID;
            } else{
        ...
        $("[id=btn_cetak]").click(function(){
          ...
          if(kd_kec == 999999 || kd_kel == 999999){
            alert('harus pilih kecamatan dan kelurahan');
          }else{
        ...
        // $('#gap_form').wrap('<form id="form_tarif" action="<?php echo active_module_url()?>approve_pembatalan/detail/" method="post"></form>');
        ...
        $("[id=btn_detail]").click(function(){
            if(ID){
                ...
                var data_params = decodeURIComponent($.param(params));
                window.location = '<?php echo active_module_url();?>approve_pembatalan/detail/'+ID+'/?'+data_params;

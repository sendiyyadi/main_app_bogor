...
$(document).ready(function(){
    $('.isotope-container').isotope({ filter: $('input[name=dashboarduptview]:checked').val() });
    $('input[name=dashboarduptview]').change(function(){
        var base = this;
        setTimeout(function(){
...
<div class="grid_5 leading" style="height:270px;">
	<fieldset class="fieldset-buttons ui-corner-all" style="margin-left:0px;">
		<legend class="buttonset-legend">
			<span id="dashboarduptview-filter" class="buttonset">
				<input type="radio" name="dashboarduptview" id="dashboarduptview-jmltrans" value=".jml-trans" checked />
				  <label for="dashboarduptview-jmltrans"><?php echo $subtitle;?></label>
				<input type="radio" name="dashboarduptview" id="dashboarduptview-nomtrans" value=".nom-trans" />
				  <label for="dashboarduptview-nomtrans"><?php echo $subtitle2;?></label>
			</span>
		</legend>

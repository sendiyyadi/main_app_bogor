            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Lebih Bayar</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Realisasi</a>
                                </li>
                                <li class="breadcrumb-item active">Lebih Bayar</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#btngo").click(function() {
            ...
            window.location = "<?php echo active_module_url() . 'lb' ?>/?tahun=" + tahun + "&buku=" + buku + "&tglawal=" + tglawal + "&tglakhir=" + tglakhir + "&kec_kd=" + kec_kd + "&kel_kd=" + kel_kd;
        });
        ...
        $("#kec_kd, #kel_kd, #tahun, #buku").change(function() {
            ...
            window.location = "<?php echo active_module_url() . 'lb' ?>" + params;
        ...
        $('#btnprint').click(function() {
            ...
            var kec_kd = $("#kec_kd").val();
            var kel_kd = $("#kel_kd").val();
            // window.open("<?php echo active_module_url() . "real_rpt/lb" ?>?tahun="+tahun+ "&kec_kd=" + kec_kd +"&kel_kd=" + kel_kd ,target="laporan");
            ...
            window.open("<?php echo active_module_url() . 'real_rpt/cetak/pdf/2' ?>/" + kec_kd + "/" + kel_kd + "/" + tahun, 'Laporan', winparams);
        });

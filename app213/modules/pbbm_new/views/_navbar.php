            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="dropdown <?php echo $current=='piutang' ? 'active' : '';?>">
                        <a href="#"  class="dropdown-toggle" data-toggle="dropdown">Piutang <strong class="caret"></strong></a>
                        <ul class="dropdown-menu">
                            <li class="dropdown"><a href="<?php echo active_module_url();?>piutang">Piutang</a></li>
                            <li class="dropdown"><a href="<?php echo active_module_url();?>piutang_nop">Piutang per NOP</a></li>
                        </ul>
                    </li>

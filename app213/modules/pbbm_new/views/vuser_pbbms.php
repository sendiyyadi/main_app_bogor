					...
					<div class="page-title-box d-flex align-items-center justify-content-between">
						...
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">User Area</li>
							</ol>
						</div>
					</div>
				</div>
...
<script>
	...
	$(document).ready(function() {
		...
		oTable = $('#table1').dataTable({
			...
			"bFilter": true,
			"bAutoWidth": false,
			"sAjaxSource": "<?php echo active_module_url(); ?>user_pbbms/grid"
		});
		...
		$('#btn_tambah').click(function() {
			window.location = '<?php echo active_module_url(); ?>user_pbbms/add/';
		});

		$('#btn_edit').click(function() {
			if (mID) {
				window.location = '<?php echo active_module_url(); ?>user_pbbms/edit/' + mID;
			} else {
				Swal.fire({
		...
		$('#btn_delete').click(function() {
			if (mID) {
				Swal.fire({
					...
					if (result.value) {
						window.location = '<?php echo active_module_url(); ?>user_pbbms/delete/' + mID;
					}
				});
			} else {
				Swal.fire({

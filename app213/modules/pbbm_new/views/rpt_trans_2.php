...
$tot3  = 0;
$baris = 45;
$title0= str_replace(" ", "&nbsp;", str_pad('REKAPITULASI HARIAN', 91, ' ', STR_PAD_BOTH))."<br>".
...
$title1 = "===========================================================================================<br>";
$title1 .= "KODE                          URAIAN                            POKOK     DENDA      JUMLAH<br>";
$title1 .= "===========================================================================================<br>";
...
if ($detail) {
    foreach ($detail as $row) {
        ...
        echo str_replace(" ", "&nbsp;", str_pad("$kode", 30, " ", STR_PAD_RIGHT)) . 
			str_replace(" ", "&nbsp;", str_pad(substr($uraian,0,26), 27, ' ', STR_PAD_RIGHT)) .

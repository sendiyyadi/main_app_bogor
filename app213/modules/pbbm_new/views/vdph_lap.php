            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Cetak File Keluaran</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">DPH</a>
                                </li>
                                <li class="breadcrumb-item active">Cetak File Keluaran</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btn_cetak').click(function() {
            if (mID) {
                /*
			var url = '<?php echo active_module_url($this->uri->segment(2)); ?>cetak/'+mID;
			window.open(url);
            */
                var rpt = 'dph';
                ...
                window.open('<?php echo active_module_url($this->uri->segment(2)); ?>cetak/pdf/' + rpt + '/' + mID, 'Laporan', winparams);
            } else {

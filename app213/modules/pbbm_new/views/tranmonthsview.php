            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Rekap Bulanan</h4>
...
<script>
    $(document).ready(function() {
        ...
        $("#tahun, #kec_kd, #kel_kd, #buku, #tahun_sppt1, #tahun_sppt2, #tp_kd").change(function() {
            ...
            var params = "?tahun=" + tahun + "&tahun_sppt1=" + tahun_sppt1 + "&tahun_sppt2=" + tahun_sppt2 + "&kec_kd=" + kec_kd + "&buku=" + buku + "&tp_kd=" + tp;
            if ($(this).attr('id') == 'kel_kd')
                var params = params + "&kel_kd=" + $(this).val();

            window.location = "<?php echo active_module_url() . 'tranmonths' ?>" + params;
        });

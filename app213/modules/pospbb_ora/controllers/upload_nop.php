...
class upload_nop extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['faction'] = active_module_url('upload_nop/unggah/' . $this->tgljam);
        //$data['current'] = 'stts';

        $this->load->view('upload_nop/vupload_nop', $data);
    }
            ...
            if (count($data) > 0) {
                ...
                foreach ($data as $row) {
                    ...
                    if ($query = $this->sppt_model->get_by_nop_thn($nop, $thn_pajak_sppt)) {
                        ...
                        $resultdb = $this->payment_model->add_bayar_per_nop($nop, $thn_pajak_sppt, $sisa_sppt, $data, $hist_bayar_dt);
        ...
        if (!empty($_FILES['userfile']['name'])) {
            ...
            if ($this->upload->do_multi_upload("userfile")) {
                ...
                while (!feof($myfile)) {
                    ...
                    //log_message('info', " 6666666666666666666666666666666  get_by_nop : ". $param_x);
                    // --------------
                    if ($query = $this->sppt_model->get_by_nop_thn($nop, $thn)) {
                        ...
                        if ($jtempo < date('Y-m-d')) {
                            ...
                            if (KD_PROPINSI == '32' && KD_DATI2 == '03') {
                                // if ((int)$thn <= 2020 && $today <= 20210630 && $today >= 20210401) {
                                //     $denda = 0;
                                // }

                                //relaksasi 04062025 rican
                                if ((int)$thn == 2025 && $today <= 20250831 && $today >= 20200201 && $faktor_pengurang_sppt == 0 && $sisa > 0) {
                                    $denda = 0;
                                }

                                if ((int)$thn >= 2020 && (int)$thn <= 2024 && $faktor_pengurang_sppt == 0 && $today <= 20250630 && $today >= 20250603 && $sisa > 0) {
                                    $denda = 0;
                                }

                                if ((int)$thn >= 2020 && (int)$thn <= 2024 && $faktor_pengurang_sppt == 0 && $today <= 20250731 && $today >= 20250701 && $sisa > 0) {
                                    $denda = 0;
                                }

                                if ((int)$thn >= 2020 && (int)$thn <= 2024 && $faktor_pengurang_sppt == 0 && $today <= 20250831 && $today >= 20250801 && $sisa > 0) {
                                    $denda = 0;
                                }

                                if ((int)$thn >= 2012 && (int)$thn <= 2019 && $faktor_pengurang_sppt == 0 && $today <= 20250630 && $today >= 20250603 && $sisa > 0) {
                                    $denda = 0;
                                }

                                if ((int)$thn >= 2012 && (int)$thn <= 2019 && $faktor_pengurang_sppt == 0 && $today <= 20250731 && $today >= 20250701 && $sisa > 0) {
                                    $denda = 0;
                                }

                                if ((int)$thn >= 2012 && (int)$thn <= 2019 && $faktor_pengurang_sppt == 0 && $today <= 20250831 && $today >= 20250801 && $sisa > 0) {
                                    $denda = 0;
                                }
                            }
                        }
                        ...
                        //relaksasi 04062025 rican
                        //2025, 02 jan 25 - 31 agus 25
                        if ($thn == 2025 && $faktor_pengurang_sppt == 0 && $today <= 20250831 && $today >= 20250102 && $sisa > 0) {
                        ...
                        //2020-2024, 03 juni 25 - 30 juni 25
                        elseif ($thn >= 2020 && $thn <= 2024 && $faktor_pengurang_sppt == 0 && $today <= 20250630 && $today >= 20250603 && $sisa > 0) {
                        ...
                        //2020-2024, 01 juli 25 - 31 juli 25
                        elseif ($thn >= 2020 && $thn <= 2024 && $faktor_pengurang_sppt == 0 && $today <= 20250731 && $today >= 20250701 && $sisa > 0) {
                        ...
                        //2020-2024, 01 agus 25 - 31 agus 25
                        elseif ($thn >= 2020 && $thn <= 2024 && $faktor_pengurang_sppt == 0 && $today <= 20250831 && $today >= 20250801 && $sisa > 0) {
                        ...
                        //2012-2019, 03 jun 25 - 30 jun 25
                        elseif ($thn >= 2012 && $thn <= 2019 && $faktor_pengurang_sppt == 0 && $today <= 20250630 && $today >= 20250603 && $sisa > 0) {
                        ...
                        //2012-2019, 01 jul 25 - 31 jul 25
                        elseif ($thn >= 2012 && $thn <= 2019 && $faktor_pengurang_sppt == 0 && $today <= 20250731 && $today >= 20250701 && $sisa > 0) {
                        ...
                        //2012-2019, 01 agus 25 - 31 agus 25
                        elseif ($thn >= 2012 && $thn <= 2019 && $faktor_pengurang_sppt == 0 && $today <= 20250831 && $today >= 20250801 && $sisa > 0) {
                        ...
                        if ($thn == 2025 && $faktor_pengurang_sppt == 0 && $today <= 20250831 && $today >= 20250102) {
                            $data = array(
                                $nop,
                                $thn,
                                number_format($sisa, 0, ',', '.'),
                                number_format($denda, 0, ',', '.'),
                                number_format($faktor_pengurang_baru, 0, ',', '.'),
                        ...
                        if ($utang > 0) {
                            ...
                            $jml_sisa  += $sisa;
                            $jml_denda += $denda;
                            // $jml_pengurangan += $nil_pengurang;
                            if ($thn == 2025 && $faktor_pengurang_sppt == 0 && $today <= 20250831 && $today >= 20250102) {
                                $jml_nil_pengurang += $faktor_pengurang_baru;
                            } else {
                                $jml_nil_pengurang += $nil_pengurang;
                            }
                            $jml_utang += $utang;
                ...
                $data = array(
                    "<b>JUMLAH TOTAL</b>",
                    "<b>" . number_format($recs, 0, ',', '.') . "</b>",
                    "<b>" . number_format($jml_sisa, 0, ',', '.') . "</b>",
                    "<b>" . number_format($jml_denda, 0, ',', '.') . "</b>",
                    "<b>" . number_format($jml_pengurangan, 0, ',', '.') . "</b>",
                ...
                $dtfile = fopen($file, "w");
                fwrite($dtfile, json_encode($aadata));
                @fclose($dtfile);
    ...
    function read_upload_recs()
    {
        ...
        $sql_query_r = "select nop, tahun, pokok, denda, pengurangan, jumlah,  nama_wp, alamat_wp
        ...
        foreach ($qry->result() as $aRow) {
            ...
            $responce->aaData[$i][] = number_format($aRow->PENGURANGAN, 0, ',', '.');

...
class lap_pengurangan_stimulus_2021 extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $module = 'POSPNGSTML';  // POS PENGURANGAN COVID 19
    ...
    public function index()
    {
        ...
        $data['current'] = 'lap_pengurangan_stimulus_2021';
	...
	*/
        //------------------------------------------------------------------
        $select_data = $this->load->model('lap_pengurangan_stimulus_2021_model')->get_select_tp();
        $options     = array();
        foreach ($select_data as $row) {
        ...
        //------------------------------------------------------------------
        $select_data = $this->load->model('lap_pengurangan_stimulus_2021_model')->get_select_kec();
        $options     = array();
        ...
        //------------------------------------------------------------------
        $select_data = $this->load->model('lap_pengurangan_stimulus_2021_model')->get_select_kel(' ');
        $options     = array();
        if ($select_data) {
        ...
        $this->load->view('lap_pengurangan_stimulus_2021/vlap_pengurangan_stimulus_2021', $data);
    }
    ...
    function get_kelurahan()
    {
        ...
        $kelurahan = $this->load->model('lap_pengurangan_stimulus_2021_model')->get_select_kel($kec_id);
    ...
    function cetak()
    {
        ...
        //
        var_dump($tglawal_);die;
        //$filter .= " and (to_char(byr.tgl_pembayaran_sppt,'YYYYMMDD') between '{$tglawal_}' and '{$tglakhir_}')";
        //$filter .= " AND byr.tgl_pembayaran_sppt BETWEEN TO_DATE('{$tglawal_}', 'YYYY-MM-DD') AND TO_DATE('{$tglakhir_}', 'YYYY-MM-DD')";
        ...
        $rpt = "lap_pengurangan_stimulus_2021";

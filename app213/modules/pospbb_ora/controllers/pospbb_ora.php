...
class pospbb_ora extends CI_Controller
{
    ...
    function create_menus_tran()
    {
        ...
        $this->apps_model->create_modules($app_id, 'batal_bendahara', 'Pembatalan STTS (Bendahara)', 'm02_mn_stts');
        $this->apps_model->create_modules($app_id, 'rekam_bayar', 'Rekam Bayar (Bendahara)', 'm02_mn_stts');
        ...
        $this->apps_model->create_modules($app_id, 'lap_hapus_denda', 'Laporan Penghapusan Sanksi Administratif', 'm04_mn_laporan');
        $this->apps_model->create_modules($app_id, 'lap_pengurangan_covid', 'Laporan Pengurangan (Covid 19)', 'm04_mn_laporan');
        $this->apps_model->create_modules($app_id, 'lap_pengurangan_stimulus_2021', 'Laporan Pengurangan (Stimulus)', 'm04_mn_laporan');
        $this->apps_model->create_modules($app_id, 'lap_rekam_bayar', 'Laporan Pembayaran Transfer', 'm04_mn_laporan');

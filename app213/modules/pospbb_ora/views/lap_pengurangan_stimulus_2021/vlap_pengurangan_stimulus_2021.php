            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Laporan Pengurangan Stimulus 2021</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Laporan</a>
                                </li>
                                <li class="breadcrumb-item active">Laporan Pengurangan Stimulus 2021</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" id="thn_pjk_awal" name="thn_pjk_awal" value="<?= date('Y'); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">s.d</label>
                                        <input class="form-control" type="number" id="thn_pjk_akhir" name="thn_pjk_akhir" value="<?= date('Y'); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
...
<script>
    ...
    function search_kelurahan(kec) {
        ...
        $.ajax({
            url: "<?php echo active_module_url() ?>lap_pengurangan_stimulus_2021/get_kelurahan/" + kec,
            success: function(j) {
    ...
    $(document).ready(function() {
        ...
        // var thn_pjk_awal_dtp = $('#thn_pjk_awal').datepicker({
        //     format: 'yyyy',
        //     viewMode: 2,
        //     // minViewMode: 2
        // }).on('changeDate', function(ev) {
        //     thn_pjk_awal_dtp.hide();
        // }).data('datepicker');
        //
        // var thn_pjk_akhir_dtp = $('#thn_pjk_akhir').datepicker({
        //     format: 'dd-mm-yyyy',
        //     minViewMode: 2
        // }).on('changeDate', function(ev) {
        //     thn_pjk_akhir_dtp.hide();
        // }).data('datepicker');

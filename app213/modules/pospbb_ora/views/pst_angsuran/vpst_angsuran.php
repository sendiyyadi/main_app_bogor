            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Angsuran Atas Pajak Berhutang</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">
                                    <a href="<?= active_module_url('pst_angsuran'); ?>">Angsuran</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2" id="angs" name="angs">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Nilai Angsuran</label>
                ...
                success: function(msg) {
                    ...
                    if (data['yes'] == 'yes') {
                        ...
                        Swal.fire({
                          icon: "success",
                          title: "Sukes",
                          text: 'Data Pembayaran telah disimpan.'
                        });
                        ...
                        Swal.fire({
                          icon: "error",
                          title: "Error",
                          text: 'Angsuran ke : ' + cicilan_ke + ',  belum dilakukan Pembayaran...!'
                        });
                    } else {

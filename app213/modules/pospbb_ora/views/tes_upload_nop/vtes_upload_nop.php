            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Cetak STTS by Upload NOP (TEST)</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">STTS</a>
                                </li>
                                <li class="breadcrumb-item active">Cetak STTS by Upload NOP (TEST)</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-2 mb-2 text-center">
                                <div class="col-md-4">
                                    <span>Raw contents of the file:</span>
                                    <span id="isi_file">No data yet.</span>
                                </div>
                                <div class="col-md-4">
                                    <span>Parsed file contents:</span>
                                    <span id="parsed_file">No data yet.</span>
                                </div>
                                <div class="col-md-4">
                                    <span>Raw Cetak : </span>
                                    <span id="isi_cetak">No data yet.</span>
                                </div>
                            </div>
                            <!-- <hr>
                            <div class="progress">
...
<script>
    ...
    function displayContents(contents) {
        var element = document.getElementById('isi_file');
        element.textContent = contents;
    }

    function displayParsed(contents) {
        const element = document.getElementById('parsed_file');
    ...
    $(document).ready(function() {
        ...
        $('#myform').ajaxForm({
            ...
            beforeSend: function() {
                $("#btn_simpan,#btn_cetak, #btn_cetak4").attr('disabled', 'disabled');
            ...
            success: function(response) {
                ...
                oTable.fnReloadAjax("<?php echo active_module_url(); ?>tes_upload_nop/read_upload_recs/?" + data_params);
                ...
                document.getElementById("parsed_file").innerHTML = '';
                document.getElementById("isi_file").innerHTML = '';
        ...
        $('#btn_simpan').click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo active_module_url('tes_upload_nop/simpan') ?>",
                ...
                success: function(msg) {
                    ...
                    if (data['simpan'] != 'gagal') {
                        ...
                        $("#btn_cetak, #btn_cetak4").removeAttr('disabled');

                        document.getElementById("isi_cetak").innerHTML = cetak;
        ...
        $('#btn_cetak').click(function() {
            ajax_download("<?php echo active_module_url('tes_upload_nop/cetak'); ?>", {
        ...
        $('#btn_cetak4').click(function() {
            ajax_download("<?php echo active_module_url('tes_upload_nop/cetak_draft'); ?>", {
                'dtCetak': JSON.stringify({
                    "dtCetak": cetak
                })
            });
        ...
        document.getElementById('userfile').addEventListener('change', load_data_csv, false);
    ...
    function ajax_download_ORI(url, data) {

...
$(document).ready(function () {
    ...
    $('#btn_cetak').click(function() {
        ajax_download("<?php echo active_module_url('bayar_by_nop_all_thn/cetak');?>", {'dtCetak': JSON.stringify({ "dtCetak" : cetak })});
    });

    $('#btn_cetak4').click(function() {
          ajax_download("<?php echo active_module_url('bayar_by_nop_all_thn/cetak_draft');?>", {'dtCetak': JSON.stringify({ "dtCetak" : cetak })});
    });
...
<div class="content">
    <div class="container-fluid">
        <ul class="nav nav-tabs" id="myTab">
            <li class="active"><a data-toggle="tab" href="#transaksi"><strong>Cetak STTS Per Tahun</strong></a></li>
        </ul>

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Laporan Pembatalan</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Laporan</a>
                                </li>
                                <li class="breadcrumb-item active">Laporan Pembatalan</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="tgl_fr" name="tgl_fr" value="<?= date('d-m-Y'); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">s.d</label>
                                        <input class="form-control" type="text" id="tgl_to" name="tgl_to" value="<?= date('d-m-Y'); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">

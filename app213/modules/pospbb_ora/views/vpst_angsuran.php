...
$(document).ready(function() {
  ...
  $("#btn_cari").click(function() {
      ...
      if (nop && thn && thn_p && bundel_p && urut_p && angs_p) {
      $.ajax({
        url: "<?php echo active_module_url('pst_angsuran/cari/')?>"+nop+'/'+thn+'/'+thn_p+'/'+bundel_p+'/'+urut_p+'/'+angs_p,
        success: function (json) {
          ...
          if(data['found']!=0) {
            ...
            //$("#jthtempo").val(data['tgl_jatuh_tempo_sppt']);
			       $("#jthtempo").val(data['JT_TEMPO_CICILAN']);
			       $("#angsuran").val(formatter.format(data['NILAI_CICILAN']));
  ...
  $('#myform').submit(function() {
    ...
    $.ajax({
      ...
      success: function(msg) {
        ...
        else if(data['yes']=='no1') {

            var cicilan_ke =data['ke'];
            alert('Angsuran ke : '+cicilan_ke+',  belum dilakukan Pembayaran...!');          
        }         
        else{
  ...
  $('#btn_cetak').click(function() {
    ...
    var thn = $("#tahun").val();
    var ke  = $("#ke").val();
    window.open("<?php echo active_module_url('pst_angsuran/cetak')?>"+ nop+'/'+thn+'/'+ke, "Cetak");
    // $(this).attr('disabled', 'disabled');
  });
  ...
  $('#btn_cetak2').click(function() {
    ...
    var thn = $("#tahun").val();
    var ke  = $("#ke").val();
    window.open("<?php echo active_module_url('pst_angsuran/cetak_draft')?>"+ nop+'/'+thn+'/'+ke, "Cetak Bank");
    // $(this).attr('disabled', 'disabled');
  });
  ...
  $('#btn_cetak3').click(function() {
    ...
    var thn = $("#tahun").val();
    var ke  = $("#ke").val();
    window.open("<?php echo active_module_url('pst_angsuran/cetak_bank')?>"+ nop+'/'+thn+'/'+ke, "Cetak Bank2");
    // $(this).attr('disabled', 'disabled');
  });
});
...
<div class="content">
    ...
    <ul class="nav nav-tabs" id="myTab">
      <li class="active"><a href="#"><strong>Angsuran Atas Pajak Terhutang</strong></a></li>
    </ul>
    ...
    <?php echo form_open($faction, array('id'=>'myform'));?>
      <div class="row">
        ...
        <div class="span1" style="margin-left: 5px;">
          ...
          <select style="width:50px" id="angs" name="angs" >
        ...
        <div class="pull-left" style="margin-left: -15px;">
          ...
          <button type="button" class="btn btn-success" id="btn_cetak"  name="btn_cetak"  disabled>Ctk (Draft))</button>
          <button type="button" class="btn btn-success" id="btn_cetak2" name="btn_cetak2" disabled>Ctk Bank (Draft)</button>
      ...
      <div class="row">
        ...
        <div class="span2" style="margin-left: 5px;">
          <label class="staticfont">Nilai Angsuran</label>
          <input class="span2" type="text" id="angsuran" name="angsuran" readonly />
        </div>
      </div>

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Penghapusan Sanksi Administrasi - Individu</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">
                                    <a href="<?= active_module_url('pst_penghapusan_individu'); ?>">Individu</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="pct_pengurangan" id="pct_pengurangan" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Denda Disetujui</label>
                                        <input class="form-control" type="text" name="denda_pengurangan" id="denda_pengurangan" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">

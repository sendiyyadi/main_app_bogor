...
$(document).ready(function () {
    ...
    $('#btn_cetak').click(function() {
          ajax_download("<?php echo active_module_url('bayar_by_range_nop_thn/cetak');?>", {'dtCetak': JSON.stringify({ "dtCetak" : cetak })});
    });

    $('#btn_cetak4').click(function() {
          ajax_download("<?php echo active_module_url('bayar_by_range_nop_thn/cetak_draft');?>", {'dtCetak': JSON.stringify({ "dtCetak" : cetak })});
    });
    ...
    <div class="container-fluid">
        ...
        <div class="asdx">
            <?php echo form_open($faction, array('id'=>'myform', 'style'=>'margin: 0px;'));?>
                ...
                <input class="span2" type="text" maxlength="30" id="blok" name="blok">&nbsp;s.d&nbsp;
                <input class="span1" type="text" maxlength="4" id="blok2" name="blok2" placeholder="no urut" >

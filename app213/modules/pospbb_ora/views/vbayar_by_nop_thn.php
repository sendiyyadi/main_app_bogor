      ...
      $.ajax({
        ...
        success: function (json) {
          ...
          if(data['found']!=0) {
            ...
            if (data['utang']>0){ $("#btn_bayar").removeAttr('disabled');}
    ...
    <?php echo form_open($faction, array('id'=>'myform'));?>
      ...
      <div class="row">
        ...
        <div class="span2" style="color: red;">
          <label class="staticfont">Pengurangan(Stimulus)</label>
          <input class="span2" type="text" style="color: red;" id="stimulus" name="stimulus" readonly />
        </div>

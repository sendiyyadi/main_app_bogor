            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Transaksi Pembayaran - Rincian User</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Transaksi</a>
                                </li>
                                <li class="breadcrumb-item active">Transaksi Pembayaran - Rincian User</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        */
        ...
        $("#btngo").click(function() {
            ...
            window.location = "<?php echo active_module_url() . 'rincian_user' ?>" + params;
        ...
        $('#btnprint').click(function() {
            ...
            window.open("<?php echo active_module_url() . 'trans_rpt/cetak/pdf/5' ?>/" + kec_kd + "/" + kel_kd + "/" + buku + "/" + tglawal + "/" + tglakhir + "/" + user_kd, 'Laporan', winparams);
        });

        $('#btn_csv').click(function() {
            var rpt_type = <?php echo $trantypes; ?>;
            var url = '<?php echo active_module_url('trans_rpt/csv_rincian_user'); ?>';
        ...
        $('#btn_xls').click(function(){
            ...
            window.open("<?php echo active_module_url().'trans_rpt/xls_rincian_user'?>/?"+data);
         });
    });
</script>

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Laporan Pengurangan Covid</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Laporan</a>
                                </li>
                                <li class="breadcrumb-item active">Laporan Pengurangan Covid</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function search_kelurahan(kec) {
        ...
        $.ajax({
            url: "<?php echo active_module_url() ?>lap_pengurangan_covid/get_kelurahan/" + kec,
            success: function(j) {

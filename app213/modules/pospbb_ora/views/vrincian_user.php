...
$(document).ready(function() {
    ...
    */
    ...
    $('#btnprint').click(function() {
        ...
        window.open("<?php echo active_module_url().'trans_rpt/cetak/pdf/1'?>/"+ kec_kd +"/"+ kel_kd +"/"+ "/" + buku +"/" + tglawal +"/"+ tglakhir+"/"+user_kd, 'Laporan', winparams);
    });
...
<div class="content">
    <div class="container-fluid">
        <ul class="nav nav-tabs" id="myTab">
            <li class="active"><a data-toggle="tab" href="#"><strong>Transaksi User – Rinci Harian</strong></a></li>
        </ul>

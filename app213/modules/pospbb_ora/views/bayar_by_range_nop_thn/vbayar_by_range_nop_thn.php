            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Cetak STTS per Range</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">STTS</a>
                                </li>
                                <li class="breadcrumb-item active">Cetak STTS per Range</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                ...
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">NOP Awal</span>
                                    </div>
                                ...
                                <div class="col-md-1">
                                    <input type="text" id="blok2" class="form-control" name="blok2" autocomplete="off" placeholder="No Urut" maxlength="4" />
                                </div>
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
            ...
            "bServerSide": false,
            "bProcessing": true,
            "sAjaxSource": "<?php echo active_module_url(); ?>bayar_by_range_nop_thn/cari/"
    ...
    $(document).ready(function() {
        ...
        $("#btn_cari").click(function() {
            ...
            if (blok && thn) {
                ...
                document.getElementById("blok2").disabled = true;
                document.getElementById("tahun").disabled = true;

                oTable.fnReloadAjax("<?php echo active_module_url(); ?>bayar_by_range_nop_thn/cari/" + blok + '/' + blok2 + '/' + thn);
            } else {
        ...
        $("#btn_reset").click(function() {
            ...
            document.getElementById("blok2").disabled = false;
        ...
        $('#btn_cetak').click(function() {
            ajax_download("<?php echo active_module_url('bayar_by_range_nop_thn/cetak'); ?>", {
        ...
        $('#btn_cetak4').click(function() {
            ajax_download("<?php echo active_module_url('bayar_by_range_nop_thn/cetak_draft'); ?>", {
                'dtCetak': JSON.stringify({
                    "dtCetak": cetak
                })
            });

...
$(document).ready(function() {
  ...
  $("#btn_cari").click(function() {
      ...
      $.ajax({
        url: "<?php echo active_module_url('pst_penghapusan_individu/cari/')?>"+nop+'/'+thn+'/'+thn_p+'/'+bundel_p+'/'+urut_p,
        success: function (json) {
          ...
          if(data['found']!=0) {
              ...
              $("#sisa").val(formatter.format(data['pjk_lama']));
              $("#jthtempo").val(data['TGL_JATUH_TEMPO_SPPT']);
              $("#denda").val(formatter.format(data['denda']));
              $("#pct_pengurangan").val(formatter.format(data['PCT_PERMOHONAN_PENGURANGAN'])+' %');
              $("#denda_pengurangan").val(formatter.format(data['denda_pengurangan']));
  ...
  $('#btn_cetak').click(function() {
    ...
    var thn = $("#tahun").val();
    var ke  = $("#ke").val();
    window.open("<?php echo active_module_url('pst_penghapusan_individu/cetak')?>"+ nop+'/'+thn+'/'+ke, "Cetak");
    // $(this).attr('disabled', 'disabled');
  });
  ...
  $('#btn_cetak2').click(function() {
    ...
    var thn = $("#tahun").val();
    var ke  = $("#ke").val();
    window.open("<?php echo active_module_url('pst_penghapusan_individu/cetak_draft')?>"+ nop+'/'+thn+'/'+ke, "Cetak Bank");
    // $(this).attr('disabled', 'disabled');
  });
  ...
  $('#btn_cetak3').click(function() {
    ...
    var thn = $("#tahun").val();
    var ke  = $("#ke").val();
    window.open("<?php echo active_module_url('pst_penghapusan_individu/cetak_bank')?>"+ nop+'/'+thn+'/'+ke, "Cetak Bank2");
    // $(this).attr('disabled', 'disabled');
  });
});
...
<div class="content">
    ...
    <ul class="nav nav-tabs" id="myTab">
      <li class="active"><a href="#"><strong>Penghapusan Sanksi Administrasi - Individu</strong></a></li>
    </ul>
    ...
    <?php echo form_open($faction, array('id'=>'myform'));?>
      <div class="row">
        ...
        <div class="span3">
          ...
          <input class="span1" type="text" id="prefix" name="prefix" value="<?php echo $prefix;?>" readonly>
                    <input class="span2" type="text" id="nop" name="nop" maxlength="20">
        </div>
        <div class="span1" style="margin-left: -25px;">
          <label class="staticfont">Tahun</label>
          <input class="span1" type="text" id="tahun" name="tahun" maxlength="4"/>
      ...
      <div class="row">
        <div class="span2" >
          <label class="staticfont">Pengurangan</label>
          <input class="span2" type="text" id="pct_pengurangan" name="pct_pengurangan" readonly />
        </div>
        <div class="span2" style="margin-left: 5px;">
          <label class="staticfont">Denda Disetujui</label>
          <input class="span2" type="text" id="denda_pengurangan" name="denda_pengurangan" readonly />
        </div>
        <div class="span3" style="margin-left: 5px;">

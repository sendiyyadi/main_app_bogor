...
$(document).ready(function() {
    ...
    $('#btn_cetak').click(function() {
          ajax_download("<?php echo active_module_url('tes_upload_nop/cetak');?>", {'dtCetak': JSON.stringify({ "dtCetak" : cetak })});
    });

    $('#btn_cetak4').click(function() {
          ajax_download("<?php echo active_module_url('tes_upload_nop/cetak_draft');?>", {'dtCetak': JSON.stringify({ "dtCetak" : cetak })});
    });
  ...
  <div class="container-fluid">
    ...
    <?php echo msg_block();?>
        ...
        <div class="span8" >
            ...
            <pre id="isi_file">No data yet.</pre>
            <h3>Parsed file contents:</h3>
            <pre id="parsed_file">No data yet.</pre>
        </div>

        <div class="span8" >
            <h3>Raw cetak : </h3>
            <pre id="isi_cetak">No data yet.</pre>
        </div>

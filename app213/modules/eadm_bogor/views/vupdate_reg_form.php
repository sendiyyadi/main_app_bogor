        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">REGISTRASI E-SPPT</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">E-Adm</a>
                                </li>
                                <li class="breadcrumb-item active">REGISTRASI E-SPPT</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="card-body">
                  ...
                  <!-- SUBJEK / WAJIB PAJAK -->
                  <div class="panel">
                    <input type="hidden" name="sts_verif" id="sts_verif" value="<?php echo $dt['sts_verif']; ?>">
                        ...
                        background-repeat:no-repeat; background-size:cover; ">
                          ...
                          <div class="row">
                            <div class="col-md-9">
                              ...
                              <input class="form-control" type="text" id="jln_op_sppt" name="jln_op_sppt" value="<?php echo $dt['jln_op_sppt']?>">
                            </div>
                            <div class="col-md-3">
                              <label class="form-label"for="blok_kav_no_op_sppt">BLOK / NO</label><br>
                              <input class="form-control" type="text" id="blok_kav_no_op_sppt" name="blok_kav_no_op_sppt" value="<?php echo $dt['blok_kav_no_op_sppt']?>">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <input class="form-control" type="text" id="nm_wp_sppt" name="nm_wp_sppt" value="<?php echo $dt['nm_wp_sppt']?>">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <input class="form-control" type="text" id="nohp" name="nohp" value="<?php echo $dt['nohp']?>">
                            </div>
                            <div class="col-md-6">
                              <label class="form-label"for="email">ALAMAT EMAIL</label><br>
                              <input class="form-control" type="text" id="email" name="email" value="<?php echo $dt['email']?>">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 hidden">
                              <label class="form-label"for="loginname">PASSWORD</label><br>
                              <input class="form-control" type="hidden" id="passwd" name="passwd" value="<?php echo $dt['passwd']?>">
                            </div>
                          </div>

                           <input class="form-control" type="hidden" id="status_verif" name="status_verif" value="<?php echo $dt['sts_verif']?>">
                           <input class="form-control" type="hidden" id="crea_date" name="crea_date" value="<?php echo $dt['crea_date']?>">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <label class="form-label"for="im_ktp">KTP</label><br>
                              <a target="_blank" href="<?php echo active_module_url().'update_reg/openblob/im_ktp_blob/'.$dt['nik'].'/'.$dt['sts_verif'].'/'.$dt['crea_date']; ?>" class="btn btn-primary " data-toggle="tooltip" title="View"></i> Lihat File</a>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-md-6">
                              <label class="form-label"for="im_lamp2">SPPT</label><br>
                              <a target="_blank" href="<?php echo active_module_url().'update_reg/openblob/im_sppt_blob/'.$dt['nik'].'/'.$dt['sts_verif'].'/'.$dt['crea_date']; ?>" class="btn btn-primary " data-toggle="tooltip" title="View"></i> Lihat File</a>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-md-6">
                              <label class="form-label"for="im_lamp4">STTS</label><br>
                              <a target="_blank" href="<?php echo active_module_url().'update_reg/openblob/im_pbb_blob/'.$dt['nik'].'/'.$dt['sts_verif'].'/'.$dt['crea_date']; ?>" class="btn btn-primary " data-toggle="tooltip" title="View"></i> Lihat File</a>
                            </div>
                          </div>
                          ...
                          <div class="row" style="margin-top:40px">
                            <div class="col-md-6">
                              ...
                              <button class="btn btn-danger" id="btn_kembali" type="button">KEMBALI</button>
                            </div>
                          </div>
                      </div>
                  </div>
...
$(document).ready(function() {
  ...
  $("#btn_simpan").on("click", function(e){
      e.preventDefault();
      $('#myform').attr('action', "<?php echo active_module_url('update_reg/simpan')?>").submit();
  });

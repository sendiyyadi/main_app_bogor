                        ...
                        background-repeat:no-repeat; background-size:cover; ">
                            ...
                            <div class="row">
                              <div class="col-md-12 mt-2">
                                <label class="form-label" for="loginname">Keterangan</label><br>
                                <textarea class="form-control" type="text" id="keterangan" name="keterangan"  ><?php echo $dt['keterangan']; ?></textarea>
                              </div>
                            </div>
...
$(document).ready(function() {
  ...
  $("#btn_tolak_old").on("click", function(e){
      e.preventDefault();
      $('#myform').attr('action', "<?php echo active_module_url('reg_esppt/tolak')?>").submit(); 
  });

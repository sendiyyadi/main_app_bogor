...
<script>
    ...
    function f_edit(id) {
        ...
        $.ajax({
            url: '<?php echo active_module_url("lampiran_pelayanan/update_status"); ?>', 
            type: 'POST',
            data: {
                id: id, 
                sts_lampiran: isChecked 
            },
            dataType: 'json',
            success: function(response) {
                if (response.status === 'success') {
                    // alert('Status Mandatory berhasil diperbarui');
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').DataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>lampiran_pelayanan/grid_lamp/<?php echo $dt['kd_jns_pelayanan']?>"
        });
        var tb_array = [];
        ...
        $('#lampiranForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo active_module_url();?>lampiran_pelayanan/insert_lampiran', 
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function(response) {

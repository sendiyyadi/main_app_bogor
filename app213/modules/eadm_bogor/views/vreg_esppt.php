            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">REGISTRASI NOP BARU</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">E-Adm</a>
                                </li>
                                <li class="breadcrumb-item active">REGISTRASI NOP BARU</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
function reload_grid() {
    ...
    oTable.fnReloadAjax("<?php echo active_module_url();?>reg_esppt/grid/?"+data_params);
}
...
$(document).ready(function() {
    oTable = $('#table1').dataTable({
      ...
      //  "bJQueryUI": true,
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo active_module_url();?>reg_esppt/grid"
    });
    ...
    $('#btn_view').click(function() {
        if(mNIK) {
            ...
            window.location = '<?php echo active_module_url();?>reg_esppt/view/'+mNIK;
        }else{
    ...
    $('#btn_action').click(function() {
        if(mNIK) {
            if(mSTS == 0){
                ...
                // var data_params = decodeURIComponent($.param(params));
                // // alert(data_params);
                // window.location = '<?php echo active_module_url();?>reg_esppt/action/?'+data_params;
                window.location = '<?php echo active_module_url();?>reg_esppt/action/'+mNIK+'/'+mSTS;
            } else {
    ...
    $('#btn_detail').click(function() {
        if(mNIK) {
            window.location = '<?php echo active_module_url();?>reg_esppt/detail/'+mNIK+'/'+mSTS;
        }else{

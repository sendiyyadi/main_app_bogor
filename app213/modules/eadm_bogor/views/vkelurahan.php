    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
         ...
         //   "bJQueryUI": true,
            ...
            "aaSorting": [[1, "asc"]],
            "aoColumnDefs": [
                { "aTargets": [0], "bSearchable": false, "bVisible": true, "sWidth": "", "sClass": "" },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>kelurahan/grid"
        });
        ...
        $('#btn_tambah').click(function() {
            window.location = '<?php echo active_module_url();?>kelurahan/add/';
        });

        $('#btn_edit').click(function() {
            if(mID) {
                window.location = '<?php echo active_module_url();?>kelurahan/edit/?id='+mID;
            }else{
        ...
        $('#btn_delete').click(function() {
            if(mID) {
                ...
                if(hapus==true) {
                    window.location = '<?php echo active_module_url();?>kelurahan/delete/?id='+mID;
                };
            }else{

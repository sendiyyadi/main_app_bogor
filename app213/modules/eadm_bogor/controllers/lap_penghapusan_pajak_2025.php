...
class lap_penghapusan_pajak_2025 extends CI_Controller
{
    private $controller = 'lap_penghapusan_pajak_2025';
    ...
    function __construct()
    {
        ...
        $module = 'lap_penghapusan_pajak_2025';
        $this->load->library('module_auth', array(
            'module' => $module
        ));

        $this->load->model(array(
            'apps_model', 'lap_penghapusan_pajak_2025_model'
        ));
    ...
    public function index()  {
        ...
        $data['page_menu'] = 'lap_penghapusan_pajak_2025';
        $data['current'] = 'lap_penghapusan_pajak_2025';
        $data['apps']    = $this->apps_model->get_active_only();

        $select_data  = $this->load->model('lap_penghapusan_pajak_2025_model')->get_select_kecamatan();
                $options      = array();
                $kec_id = '';
                if($select_data) {
        ...
        $this->load->view('vlap_penghapusan_pajak_2025', $data);
    }

    function get_kelurahan() {
        //log_message('info', "sssssssssssssssssssssssssssssssss");
        $kec_id    = $this->uri->segment(4);
        $kelurahan = $this->load->model('lap_penghapusan_pajak_2025_model')->get_select_kel($kec_id);
    ...
    function cetak() {
        ...
        $rpt = "lap_penghapusan_pajak_2025_2";

        $query = $this->load->model('lap_penghapusan_pajak_2025_model')->query_rpt_2($filter);

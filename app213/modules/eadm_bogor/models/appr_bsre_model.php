...
class appr_bsre_model extends CI_Model
{
    ...
    public function update_data_appr_bsretemp($rowid, $data)
    {
    ...
    public function update_data_appr_bsretemp_by_nik($nik, $data)
    {
    ...
    public function insert_user_group($data)
    {
     ...
     function cek_appr_bsre($nik, $kd_prop, $kd_dati2, $kd_kecamatan, $kd_kelurahan, $kd_blok,$no_urut, $kd_jns_op){

...
class simulasi_sppt_dafnom extends CI_Controller {
    public function __construct() {
        ...
        $module = 'simulasi_sppt_dafnom';
        $this->load->library('module_auth', array(
            'module' => $module
        ));

        $this->load->model(array(
            'apps_model', 'simulasi_sppt_dafnom_model'
        ));
    ...
    public function index() {
        ...
        $data['page_menu'] = 'simulasi_sppt_dafnom';
        $data['current'] = '';
        ...
        $data['faction'] = active_module_url("simulasi_sppt_dafnom/proses/");
        $data['dt']['nop'] = get_string('');
        $data['dt']['tahun'] = get_string('');
        $data['dt']['jatuh_tempo'] = get_string('');

        $this->load->view('vsimulasi_sppt_dafnom', $data);
    }
    ...
    public function cek_nop($value) {
        ...
        if ($this->simulasi_sppt_dafnom_model->cek_nop($nop)) {
            return true;
        } else {
    ...
    public function proses() {
        if (!$this->module_auth->update) {
            ...
            redirect(active_module_url('simulasi_sppt_dafnom'));
        }
        ...
        if ($this->form_validation->run() == true) {
            ...
            $qry_manuwal = "CALL SP_SIMULASI_SPPT_DAFNOM('{$kd_prop}', '{$kd_dati}', '{$kd_kec}', '{$kd_kel}', '{$kd_blok}', '{$no_urut}', 
    ...
    public function detail() {
        ...
        $dt = $this->simulasi_sppt_dafnom_model->get($nopthn);
        ...
        if ($dt){
            ...
            $this->load->view('vsimulasi_sppt_dafnom_detail', $data);

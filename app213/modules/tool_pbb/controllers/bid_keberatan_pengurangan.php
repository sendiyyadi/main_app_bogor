...
class bid_keberatan_pengurangan extends CI_Controller {
    public function __construct() {
        ...
        $module = 'bid_keberatan_pengurangan';
    ...
    public function index() {
        ...
        $data['current'] = 'bid_keberatan_pengurangan';
        ...
        $this->load->view('vbid_keberatan_pengurangan', $data);
    }
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/bid_keberatan_pengurangan');
        // }
        ...
        if ($x){
            ...
            $this->load->view('vbid_keberatan_pengurangan_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('bid_keberatan_pengurangan'));
        }
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'bid_keberatan_pengurangan/openblob_permo/' . $field . '/' . $id_ppo;

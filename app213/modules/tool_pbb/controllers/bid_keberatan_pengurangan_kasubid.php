...
class bid_keberatan_pengurangan_kasubid extends CI_Controller {
    public function __construct() {
        ...
        $module = 'bid_keberatan_pengurangan_kasubid';
    ...
    public function index() {
        ...
        $data['current'] = 'bid_keberatan_pengurangan_kasubid';
        ...
        $this->load->view('vbid_keberatan_pengurangan_kasubid', $data);
    }
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/bid_keberatan_pengurangan_kasubid');
        // }
        ...
        if ($x){
            ...
            $this->load->view('vbid_keberatan_pengurangan_kasubid_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('bid_keberatan_pengurangan_kasubid'));
        }
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'bid_keberatan_pengurangan_kasubid/openblob_permo/' . $field . '/' . $id_ppo;

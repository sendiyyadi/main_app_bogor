...
class bid_keberatan_pengurangan_kaban extends CI_Controller {
    public function __construct() {
        ...
        $module = 'bid_keberatan_pengurangan_kaban';
    ...
    public function index() {
        ...
        $data['current'] = 'bid_keberatan_pengurangan_kaban';
        ...
        $this->load->view('vbid_keberatan_pengurangan_kaban', $data);
    }
    ...
    public function grid() {
        ...
        if(!empty($tgl_fr)){
            $this->datatables->where("TO_DATE(TO_CHAR(P.TGL_SEKBAN,'yyyy-mm-dd'), 'yyyy-mm-dd') >= TO_DATE('".$tgl_fr."', 'dd-mm-yyyy')");
        }

        if(!empty($tgl_to)){
            $this->datatables->where("TO_DATE(TO_CHAR(P.TGL_SEKBAN,'yyyy-mm-dd'), 'yyyy-mm-dd') <= TO_DATE('".$tgl_to."', 'dd-mm-yyyy')");
        }
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/bid_keberatan_pengurangan_kaban');
        // }
        ...
        if ($x){
            ...
            $this->load->view('vbid_keberatan_pengurangan_kaban_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('bid_keberatan_pengurangan_kaban'));
        }
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'bid_keberatan_pengurangan_kaban/openblob_permo/' . $field . '/' . $id_ppo;

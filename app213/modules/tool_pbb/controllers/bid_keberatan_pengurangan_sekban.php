...
class bid_keberatan_pengurangan_sekban extends CI_Controller {
    public function __construct() {
        ...
        $module = 'bid_keberatan_pengurangan_sekban';
    ...
    public function index() {
        ...
        $data['current'] = 'bid_keberatan_pengurangan_sekban';
        ...
        $this->load->view('vbid_keberatan_pengurangan_sekban', $data);
    }
    ...
    public function grid() {
        ...
        if(!empty($tgl_fr)){
            $this->datatables->where("TO_DATE(TO_CHAR(P.TGL_BID_PKP,'yyyy-mm-dd'), 'yyyy-mm-dd') >= TO_DATE('".$tgl_fr."', 'dd-mm-yyyy')");
        }

        if(!empty($tgl_to)){
            $this->datatables->where("TO_DATE(TO_CHAR(P.TGL_BID_PKP,'yyyy-mm-dd'), 'yyyy-mm-dd') <= TO_DATE('".$tgl_to."', 'dd-mm-yyyy')");
        }
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/bid_keberatan_pengurangan_sekban');
        // }
        ...
        if ($x){
            ...
            $this->load->view('vbid_keberatan_pengurangan_sekban_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('bid_keberatan_pengurangan_sekban'));
        }
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'bid_keberatan_pengurangan_sekban/openblob_permo/' . $field . '/' . $id_ppo;

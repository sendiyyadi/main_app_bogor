...
class pnt_aktivasi_nop_verif extends CI_Controller {
    ...
    public function index() {
        ...
        $data['current'] = 'pnt_aktivasi_nop_verif';
        ...
        $this->load->view('vpnt_aktivasi_nop_verif', $data);
    }
    ...
    public function grid() {
        ...
        $this->datatables->where("P.KD_JNS_PELAYANAN", "22");
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/pnt_aktivasi_nop_verif');
        // }
        ...
        if ($x){
            ...
            $this->load->view('vpnt_aktivasi_nop_verif_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('pnt_aktivasi_nop_verif'));
        }
    ...
    function approve_permohonan() {
        ...
        if ($dt) {
            ...
            // $err_Msg_2 = null;
            if (!empty($err_Msg_2)) {
                $error_CRUD = $err_Msg_2 . ', Proses Verifikator Penetapan gagal....!!!';
                $res_msg    = $error_CRUD;
                $res_code   = 500;
            } else {
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'pnt_aktivasi_nop_verif/openblob_permo/' . $field . '/' . $id_ppo;

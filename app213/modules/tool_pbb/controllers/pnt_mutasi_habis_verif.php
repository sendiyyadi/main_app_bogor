...
class pnt_mutasi_habis_verif extends CI_Controller {
    ...
    public function index() {
        ...
        $data['current'] = 'pnt_mutasi_habis_verif';
        ...
        $this->load->view('vpnt_mutasi_habis_verif', $data);
    }
    ...
    public function detail() {
        ...
        if ($dt){
            ...
            $this->load->view('vpnt_mutasi_habis_verif_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('pnt_mutasi_habis_verif'));
        }
    ...
    public function edit() {
        ...
        if ($cek_heula > 0) {
            ...
            redirect('tool_pbb/pnt_mutasi_habis_verif');
        }
    ...
    function approve_permohonan() {
        ...
        if ($dt){
            ...
            $this->permohonan_online_upt_model->update_pst_permohonan_tool($id_ppo, $dt_pst);
            ...
            // $err_Msg_2 = null;
            if (!empty($err_Msg_2)) {
                $error_CRUD = $err_Msg_2 . ', Proses verifikasi Penetapan gagal....!!!';
                $res_msg    = $error_CRUD;
                $res_code   = 500;
            } else {
                $res_msg    = 'Data berhasil diproses verifikato penetapan';
                $res_code   = 200;
            }

...
class bid_keberatan_angsuran extends CI_Controller {
    ...
    public function index() {
        ...
        $data['current'] = 'bid_keberatan_angsuran';
        ...
        $this->load->view('vbid_keberatan_angsuran', $data);
    }
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/bid_keberatan_angsuran');
        // }
        ...
        if ($x){
            ...
            $this->load->view('vbid_keberatan_angsuran_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('bid_keberatan_angsuran'));
        }
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'bid_keberatan_angsuran/openblob_permo/' . $field . '/' . $id_ppo;

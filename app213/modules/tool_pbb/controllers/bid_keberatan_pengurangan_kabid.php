...
class bid_keberatan_pengurangan_kabid extends CI_Controller {
    public function __construct() {
        ...
        $module = 'bid_keberatan_pengurangan_kabid';
    ...
    public function index() {
        ...
        $data['current'] = 'bid_keberatan_pengurangan_kabid';
        ...
        $this->load->view('vbid_keberatan_pengurangan_kabid', $data);
    }
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/bid_keberatan_pengurangan_kabid');
        // }
        ...
        if ($x){
            ...
            $this->load->view('vbid_keberatan_pengurangan_kabid_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('bid_keberatan_pengurangan_kabid'));
        }
    ...
    function approve_permohonan() {
        ...
        if ($dt) {
            ...
            // $jns_bid = '3B';
            // $get_dt_pegawai = $this->permohonan_online_upt_model->get_next_pegawai_penetapan($jns_bid, $kdjns);
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'bid_keberatan_pengurangan_kabid/openblob_permo/' . $field . '/' . $id_ppo;

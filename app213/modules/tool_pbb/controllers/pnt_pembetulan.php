...
class pnt_pembetulan extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('vpnt_pembetulan', $data);
    }
    ...
    public function detail() {
        ...
        //     redirect('tool_pbb/pnt_pembetulan');
        // }
        ...
        if ($dt){
            ...
            $this->load->view('vpnt_pembetulan_form', $data);

        } else {
            $this->session->set_flashdata('msg_error', 'Data tidak ditemukan..');
            redirect(active_module_url('pnt_pembetulan'));
        }
    ...
    function approve_permohonan() {
        ...
        if ($dt){
            ...
            $qry1 = "CALL SP_PNT_PEMBETULAN_OL({$id_ppo}, '{$nip_pencetak}') ";
            ...
            if (!empty($err_Msg_1)) {
                ...
                if (!empty($err_Msg_2)) {
                    ...
                    $d_email        = $this->input->post('email_wp_sppt');
    ...
    function btn_file($field, $id_ppo) { 
        $url = active_module_url() . 'pnt_pembetulan/openblob_permo/' . $field . '/' . $id_ppo;

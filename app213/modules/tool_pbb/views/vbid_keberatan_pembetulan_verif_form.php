            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">VERIFIKASI BIDANG KEBERATAN - PEMBETULAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Verif Bidang Keberatan - Pembetulan</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                  ...
                                  <div class="row" style="margin-right:0px; margin-left:0px; background-image:url(<?php echo site_url('assets/img/stadion_pakansari.jpg'); ?>);
                                    ...
                                    <div class="col-md-12 ">
                                      ...
                                      <div id="row_bawah" class="">
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <?php if ($this->uri->segment(3) != 'detail' && ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') ) { ?>
                                        ...
                                        <table style="width:100%; border-collapse:collapse;">
                                            ...
                                            <?php foreach ($syarat as $i => $row): ?>
                                                <tr>
                                                    ...
                                                    <!-- KETERANGAN -->
                                                    <td>
                                                        <input type="text" class="form-control" <?= ($mode === 'view') ? 'readonly' : '' ?> 
                                                               name="ket[<?= $row->ID ?>]"
                                                               style="width:100%;"
                                        ...
                                        <div class="row" >
                                          ...
                                          <div class="col-md-1" >
                                              <label>LAMPIRAN PENDANIL 1</label>
                                          </div>
                                          <div class="col-md-2">
                                            <!-- Khusus yang lewat pendanil, tidak bisa ubah atau upload ulang (kd_sub_jns 01) -->
                                            <?php if ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') { ?>
                                          ...
                                          <div class="col-md-1" >
                                              <label>LAMPIRAN PKP 1</label>
                                          </div>
                                          <div class="col-md-2">
                                            <?php if ($this->uri->segment(3) != 'detail') { ?>
                                            <input type="file" id="im_l_pkp1" style="display: inline;" name="im_l_pkp1" accept=".pdf,.jpg, .png, .jpeg">
                                            <span id="span_im_l_pkp1"></span>
                                            <?php } ?>
                                          </div>
                                        </div>
                                        ...
                                        <div class="row" >
                                          ...
                                          <div class="col-md-1" >
                                              <label>LAMPIRAN PENDANIL 2</label>
                                          </div>
                                          <div class="col-md-2">
                                            <!-- Khusus yang lewat pendanil, tidak bisa ubah atau upload ulang (kd_sub_jns 01) -->
                                            <?php if ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') { ?> 
                                          ...
                                          <div class="col-md-1" >
                                              <label>LAMPIRAN PKP 2</label>
                                          </div>
                                          <div class="col-md-2">
                                            <?php if ($this->uri->segment(3) != 'detail') { ?>
                                            <input type="file" id="im_l_pkp2" style="display: inline;" name="im_l_pkp2" accept=".pdf,.jpg, .png, .jpeg">
                                            <span id="span_im_l_pkp2"></span>
                                            <?php } ?>
                                          </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-6" style="align-self:start;">
                                            ...
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                                <label for="proses_pk">PROSES</label>
                                              </div>
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="proses_pk" name="proses_pk" autocomplete="off" value="<?php echo $dt['proses_pk']?>" style="text-transform:uppercase;" maxlength="500" >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="analisa_pk" name="analisa_pk" autocomplete="off" value="<?php echo $dt['analisa_pk']?>" style="text-transform: uppercase;" maxlength="500" >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="keterangan_pk" name="keterangan_pk" autocomplete="off" value="<?php echo $dt['keterangan_pk']?>" style="text-transform: uppercase;" maxlength="500" >
                                              </div>
                                            </div>
                                            ...
                                            <div class="row" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="proses_pl" name="proses_pl" autocomplete="off" value="<?php echo $dt['proses_pl']?>" style="text-transform:uppercase;" maxlength="500" >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="analisa_pl" name="analisa_pl" autocomplete="off" value="<?php echo $dt['analisa_pl']?>" style="text-transform: uppercase;" maxlength="500" >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="keterangan_pl" name="keterangan_pl" autocomplete="off" value="<?php echo $dt['keterangan_pl']?>" style="text-transform: uppercase;" maxlength="500" >
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="col-md-6" style="align-self:start;">
                                            ...
                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">NAMA WP</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="nmwp_sblm" name="nmwp_sblm" value="<?php echo $dt['nmwp_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="nmwp_ssdh" name="nmwp_ssdh" value="<?php echo $dt['nmwp_ssdh']?>" readonly >
                                              </div>
                                            </div>

                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">ALAMAT WP</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="alamatwp_sblm" name="alamatwp_sblm" value="<?php echo $dt['alamatwp_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="alamatwp_ssdh" name="alamatwp_ssdh" value="<?php echo $dt['alamatwp_ssdh']?>" readonly >
                                              </div>
                                            </div>

                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">ALAMAT OP</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="alamatop_sblm" name="alamatop_sblm" value="<?php echo $dt['alamatop_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="alamatop_ssdh" name="alamatop_ssdh" value="<?php echo $dt['alamatop_ssdh']?>" readonly >
                                              </div>
                                            </div>

                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">KD ZNT</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="kdznt_sblm" name="kdznt_sblm" value="<?php echo $dt['kdznt_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="kdznt_ssdh" name="kdznt_ssdh" value="<?php echo $dt['kdznt_ssdh']?>" readonly >
                                              </div>
                                            </div>

                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">LUAS BUMI</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="luas_bumi_sblm" name="luas_bumi_sblm" value="<?php echo $dt['luas_bumi_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="luas_bumi_ssdh" name="luas_bumi_ssdh" value="<?php echo $dt['luas_bumi_ssdh']?>" readonly >
                                              </div>
                                            </div>

                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">LUAS BANGUNAN</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="luas_bng_sblm" name="luas_bng_sblm" value="<?php echo $dt['luas_bng_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="luas_bng_ssdh" name="luas_bng_ssdh" value="<?php echo $dt['luas_bng_ssdh']?>" readonly >
                                              </div>
                                            </div>

                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">NJOP BUMI PERM</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="njop_bumi_sblm" name="njop_bumi_sblm" value="<?php echo $dt['njop_bumi_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="njop_bumi_ssdh" name="njop_bumi_ssdh" value="<?php echo $dt['njop_bumi_ssdh']?>" readonly >
                                              </div>
                                            </div>

                                            <div class="row" >
                                              <div class="col-md-3">
                                                <label for="keterangan_pl">NJOP BNG PERM</label>
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="njop_bng_sblm" name="njop_bng_sblm" value="<?php echo $dt['njop_bng_sblm']?>" readonly >
                                              </div>
                                              <div class="col-md-4">
                                                <input class="form-control" type="text" id="njop_bng_ssdh" name="njop_bng_ssdh" value="<?php echo $dt['njop_bng_ssdh']?>" readonly >
                                              </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top:40px">
                                          <div class="col-md-12">
                                            <?php if ($this->uri->segment(3) != 'detail') { ?>
                                              <?php if ($dt['sts_permo'] == '8') { ?>
                                              <button class="btn btn-success" id="btn_batal" type="submit">APPROVE VERIFIKATOR BIDANG KEBERATAN</button>
                                              <button class="btn btn-warning" id="btn_tolak_ply" type="button" >TOLAK KELENGKAPAN DATA</button>
                                              <?php } else if ($dt['sts_permo'] == 'C') { ?>
                                                <button class="btn btn-danger" id="btn_tolak" type="button" >PERMOHONAN TIDAK DIKABULKAN</button>
                                              <?php } ?>
                                            <?php } ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <?php if ($this->uri->segment(3) == 'edit' && ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') ) { ?>
          <div class="row" style="margin-right:0px; margin-left:0px">
            <div class="well" style="padding:10px;min-height:10px; background-color:#5D6385; color:#FFF;">
              <center>
...
function f_hapus_detail(id_dob) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('bid_keberatan_pembetulan_verif'); ?>delete_dtl_bng/' + id_dob,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
function f_hapus_detail_fas(id_fas) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('bid_keberatan_pembetulan_verif'); ?>delete_dtl_fas_bng/' + id_fas,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
$(document).ready(function() {
  ...
  oTable = $('#tableKD').dataTable({
    ...
    "aoColumnDefs": [
        ...
        { "aTargets": [7], "bSearchable": true,  "bVisible": <?php echo ($this->uri->segment(3) == 'edit' && ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') ) ? 'true' : 'false' ; ?>, "sWidth": "100px", "sClass": "center", 
            "mRender": function ( source, type, val ) {
                <?php if($this->uri->segment(3) == 'edit' && ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') ) { ?>
  ...
  oTable2 = $('#tableKDFas').dataTable({
    ...
    "aoColumnDefs": [
        ...
        { "aTargets": [5], "bSearchable": true,  "bVisible": <?php echo ($this->uri->segment(3) == 'edit' && ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') ) ? 'true' : 'false' ; ?>, "sWidth": "100px", "sClass": "center", 
            "mRender": function ( source, type, val ) {
              <?php if ($this->uri->segment(3) == 'edit' && ($dt['kd_sub_jns_ply'] == '01' || $dt['kd_sub_jns_ply'] == '02') ) { ?>
  ...
  $('#myform').on('submit', function(e) {
      ...
      $.ajax({
          url: "<?php echo active_module_url() ?>bid_keberatan_pembetulan_verif/approve_permohonan/",
          type: 'POST',
          data: data,
          processData: false,
          contentType: false,
          ...
          success: function(res) {
              ...
              if (res.result == 400) {
                  ...
                  Swal.fire({
                      ...
                      window.location = '<?php echo active_module_url("bid_keberatan_pembetulan_verif"); ?>';
                  });
              }
          },
          complete: function () {
  ...
  $('#btn_tolak').on('click', function() {
    ...
    Swal.fire({
        ...
        text: "Permohonan yang sudah ditolak tidak dapat dikembalikan. Anda dapat mengunduh SK Penolakan ketika data sudah ditolak",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "<?php echo active_module_url() ?>bid_keberatan_pembetulan_verif/tolak_permohonan/",
                type: 'POST',
                data: data,
                processData: false,
                contentType: false,
  ...
  $('#btn_save_dsp').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_verif/save_data_subjek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
  ...
  $('#btn_save_dop').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_verif/save_data_objek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
  ...
  $('#btn_hitung_njop_bng').click(function(e) {
    ...
    $.ajax({
        url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_verif/hitung_njop_bng/',
        type: "POST",    
        data: {
          id_ppo: id_ppo,
          paramm: paramm,
        ...
        success: function(response) {
            ...
            $.ajax({
                url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_verif/get_data_pembanding/',
                type: "POST",    
                data: {
                  id_ppo: id_ppo,
                },
                success: function(response) {
                    ...
                    $('#luas_bumi_sblm').autoNumeric('set', data['luas_bumi_sblm']);
                    $('#luas_bng_sblm').autoNumeric('set', data['luas_bng_sblm']);
                    $('#njop_bumi_sblm').autoNumeric('set', data['njop_bumi_sblm']);
                    $('#njop_bng_sblm').autoNumeric('set', data['njop_bng_sblm']);
                    $('#luas_bumi_ssdh').autoNumeric('set', data['luas_bumi_ssdh']);
                    $('#luas_bng_ssdh').autoNumeric('set', data['luas_bng_ssdh']);
                    $('#njop_bumi_ssdh').autoNumeric('set', data['njop_bumi_ssdh']);
                    $('#njop_bng_ssdh').autoNumeric('set', data['njop_bng_ssdh']);
  ...
  $('#btn_hitung_njop_bumi').click(function(e) {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_verif/hitung_njop_bumi/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            luas_bumi: luas_bumi,
  ...
  $('#btn_tolak_ply').on('click', function () {
      ...
      Swal.fire({
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>bid_keberatan_pembetulan_verif/tolak_ke_pelayanan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,

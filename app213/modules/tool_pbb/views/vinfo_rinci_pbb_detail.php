...
.table th, .table td {
    ...
    <div class="content" style="margin-right:10%; margin-left:10%; margin-top:20px">
        <div class="container-fluid">
            ...
            <h4 style="font-weight:bold; text-align:center;">INFORMASI RINCI SPPT PBB KABUPATEN BOGOR</h4>
            <hr/>
                ...
                <div class="row" style="margin-top:10px; margin-bottom:10px;">
                    <div class="col-md-6" style="padding-right:0px;">
                        <div class="row" style="margin-right:0px; border: 1px black solid;">
                            <div class="col-md-6 col-sm-6 col-xs-6 tx-kanan" >
                                LETAK OBJEK PAJAK :
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6 tx-kiri">

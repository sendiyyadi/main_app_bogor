            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">BIDANG KEBERATAN - ANGSURAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Bidang Keberatan - Angsuran</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>bid_keberatan_angsuran/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("bid_keberatan_angsuran/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == 'A' || sts == 'C' ) {
            window.location = '<?php echo active_module_url("bid_keberatan_angsuran/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        ...
        var url = '<?php echo active_module_url(); ?>bid_keberatan_angsuran/cetak_sk_tolak/' + id;
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>bid_keberatan_angsuran/grid"
        });

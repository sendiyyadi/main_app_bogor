            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">VERIFIKASI PENETAPAN - AKTIVASI SPPT</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Verif Penetapan - Aktivasi SPPT</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pnt_aktivasi_nop_verif/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pnt_aktivasi_nop_verif/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == 'H' ) {
            window.location = '<?php echo active_module_url("pnt_aktivasi_nop_verif/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        ...
        var url = '<?php echo active_module_url(); ?>pnt_aktivasi_nop_verif/cetak_sk_tolak/' + id;
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pnt_aktivasi_nop_verif/grid"
        });

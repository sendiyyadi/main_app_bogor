            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">BIDANG KEBERATAN - PELAYANAN ANGSURAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Bidang Keberatan - Pelayanan Angsuran</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                      ...
                                      <div id="row_bawah" class="">
                                        ...
                                        <div class="row" style="margin-top:40px">
                                          <div class="col-md-6">
                                            ...
                                            <button class="btn btn-success" id="btn_approve" type="submit">Approve</button>
                                            <button class="btn btn-warning" id="btn_tolak" type="button">Tolak</button>
                                            <button class="btn btn-warning" id="btn_tolak_ply" type="button" >TOLAK PELAYANAN</button>
                                            <?php } ?>
...
$(document).ready(function() {
  ...
  $('#btn_back').on('click', function() {
    window.location = '<?php echo active_module_url("bid_keberatan_angsuran"); ?>';
  }); 
  ...
  //           $('#myform').attr('action', "<?php echo active_module_url('bid_keberatan_angsuran/approve_permohonan') ?>").submit();
  //       }
  //   });
  ...
  //       }).then((result) => {
  //           if (result.isConfirmed) {
  //               $('#myform').attr('action', "<?php echo active_module_url('bid_keberatan_angsuran/tolak_permohonan') ?>").submit();
  //           }
  //       });
  //   }
  ...
  $('#myform').on('submit', function(e) {
      ...
      $.ajax({
          url: "<?php echo active_module_url() ?>bid_keberatan_angsuran/approve_permohonan/",
          type: 'POST',
          data: data,
          processData: false,
          contentType: false,
  ...
  $('#btn_tolak').on('click', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "<?php echo active_module_url() ?>bid_keberatan_angsuran/tolak_permohonan/",
                type: 'POST',
                data: data,
                processData: false,
                contentType: false,
  ...
  $('#btn_tolak_ply').on('click', function () {
      ...
      Swal.fire({
          title: 'Tolak Berkas?',
          text: 'Tolak Berkas ini dan kembalikan ke Loket Pelayanan?',
          icon: 'warning',
          input: 'textarea',
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>bid_keberatan_angsuran/tolak_ke_pelayanan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,

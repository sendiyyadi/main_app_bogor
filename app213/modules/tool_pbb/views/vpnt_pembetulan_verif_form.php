            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">VERIFIKASI PENETAPAN - PEMBETULAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Verifikasi Penetapan - Pembetulan</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                  ...
                                  <div class="row" style="margin-right:0px; margin-left:0px; background-image:url(<?php echo site_url('assets/img/stadion_pakansari.jpg'); ?>);
                                    ...
                                    <div class="col-md-12 ">
                                      ...
                                      <div id="row_bawah" class="">
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <?php if ($this->uri->segment(3) == 'edit' && $dt['kd_sub_jns_ply'] == '01') { ?>
                                        ...
                                        <div class="row" >
                                          ...
                                          <div class="col-md-4">
                                              <input class="form-control" type="text" id="ket_verlap" name="ket_verlap" autocomplete="off" value="<?php echo $dt['ket_verlap']?>" style="text-transform: uppercase;" readonly >
                                          </div>
                                          <div class="col-md-1" >
                                        ...
                                        <div class="row" >
                                          ...
                                          <div class="col-md-4">
                                              <input class="form-control" type="text" id="rekom_verlap" name="rekom_verlap" autocomplete="off" value="<?php echo $dt['rekom_verlap']?>" style="text-transform: uppercase;" readonly >
                                          </div>
                                          <div class="col-md-1" >
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-6" style="align-self:start;">
                                            ...
                                            <div class="row" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="proses_pk" name="proses_pk" autocomplete="off" value="<?php echo $dt['proses_pk']?>" style="text-transform:uppercase;" readonly >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="analisa_pk" name="analisa_pk" autocomplete="off" value="<?php echo $dt['analisa_pk']?>" style="text-transform: uppercase;" readonly >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="keterangan_pk" name="keterangan_pk" autocomplete="off" value="<?php echo $dt['keterangan_pk']?>" style="text-transform: uppercase;" readonly >
                                              </div>
                                            </div>
                                            ...
                                            <div class="row" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="proses_pl" name="proses_pl" autocomplete="off" value="<?php echo $dt['proses_pl']?>" style="text-transform:uppercase;" readonly >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="analisa_pl" name="analisa_pl" autocomplete="off" value="<?php echo $dt['analisa_pl']?>" style="text-transform: uppercase;" readonly >
                                              </div>
                                            </div>
                                            <div class="row" >
                                              <div class="col-md-4 row_ba" >
                                              ...
                                              <div class="col-md-7">
                                                  <input class="form-control" type="text" id="keterangan_pl" name="keterangan_pl" autocomplete="off" value="<?php echo $dt['keterangan_pl']?>" style="text-transform: uppercase;" readonly >
                                              </div>
                                            </div>
                                          </div>
                                        ...
                                        <div class="row" style="margin-top:40px">
                                          <div class="col-md-6">
                                            <?php if ($this->uri->segment(3) != 'detail') { ?>
                                            <button class="btn btn-success" id="btn_batal" type="submit">APPROVE VERIFIKASI PENETAPAN</button>
                                            
                                            <?php if ($dt['kd_sub_jns_ply'] == '03') { ?>
                                              <!-- <button class="btn btn-warning" id="btn_tolak_kelengkapan" type="button" >TOLAK KELENGKAPAN DATA</button> -->
                                            <?php } else { ?>
...
function f_hapus_detail(id_dob) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('pnt_pembetulan_verif'); ?>delete_dtl_bng/' + id_dob,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
function f_hapus_detail_fas(id_fas) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('pnt_pembetulan_verif'); ?>delete_dtl_fas_bng/' + id_fas,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
$(document).ready(function() {
  ...
  oTable = $('#tableKD').dataTable({
    ...
    "aoColumnDefs": [
        ...
        { "aTargets": [7], "bSearchable": true,  "bVisible": <?php echo ($this->uri->segment(3) == 'edit' && $dt['kd_sub_jns_ply'] == '01') ? 'true' : 'false' ; ?>, "sWidth": "100px", "sClass": "center", 
            "mRender": function ( source, type, val ) {
                <?php if($this->uri->segment(3) == 'edit' && $dt['kd_sub_jns_ply'] == '01') { ?>
  ...
  $('#btn_save_dtl').click(function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            alert(response + '. Silakan Hitung NJOP Ulang.');
  ...
  oTable2 = $('#tableKDFas').dataTable({
    ...
    "aoColumnDefs": [
        ...
        { "aTargets": [5], "bSearchable": true,  "bVisible": <?php echo ($this->uri->segment(3) == 'edit' && $dt['kd_sub_jns_ply'] == '01') ? 'true' : 'false' ; ?>, "sWidth": "100px", "sClass": "center", 
            "mRender": function ( source, type, val ) {
              <?php if ($this->uri->segment(3) == 'edit' && $dt['kd_sub_jns_ply'] == '01') { ?>
  ...
  $('#btn_save_dtl_fas').click(function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            alert(response+'. Harap hitung NJOP Bangunan Ulang.');
  ...
  $('#myform').on('submit', function(e) {
      ...
      $.ajax({
          url: "<?php echo active_module_url() ?>pnt_pembetulan_verif/approve_permohonan/",
          type: 'POST',
          data: data,
          processData: false,
          contentType: false,
          ...
          success: function(res) {
              ...
              if (res.result == 400) {
                  ...
                  Swal.fire({
                      ...
                      window.location = '<?php echo active_module_url("pnt_pembetulan_verif"); ?>';
                  });
              }
          },
          complete: function () {
  ...
  $('#btn_save_dsp').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/pnt_pembetulan_verif/save_data_subjek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
          ...
          success: function(response) {
            alert(response  + '. Silahkan hitung NJOP Bumi Ulang.');
            document.getElementById('btn_batal').disabled = true;
  ...
  $('#btn_save_dop').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/pnt_pembetulan_verif/save_data_objek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
          ...
          success: function(response) {
              alert(response + '. Silahkan hitung NJOP Bangunan Ulang.');
              document.getElementById('btn_batal').disabled = true;
  ...
  $('#btn_hitung_njop_bng').click(function(e) {
    ...
    $.ajax({
        url: '<?php echo active_module_url(); ?>/pnt_pembetulan_verif/hitung_njop_bng/',
        type: "POST",    
        data: {
          id_ppo: id_ppo,
          paramm: paramm,
        ...
        success: function(response) {
            ...
            $.ajax({
                url: '<?php echo active_module_url(); ?>/pnt_pembetulan_verif/get_data_pembanding/',
                type: "POST",    
                data: {
                  id_ppo: id_ppo,
                },
  ...
  $('#btn_hitung_njop_bumi').click(function(e) {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/pnt_pembetulan_verif/hitung_njop_bumi/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            luas_bumi: luas_bumi,
  ...
  $('#btn_tolak_ply').on('click', function () {
      ...
      Swal.fire({
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>pnt_pembetulan_verif/tolak_ke_pelayanan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,
  ...
  $('#btn_tolak_kelengkapan').on('click', function () {

      Swal.fire({
          title: 'Tolak Berkas?',
          text: 'Tolak Berkas ini dan kembalikan ke WP?',
          icon: 'warning',
          input: 'textarea',
          inputLabel: 'Keterangan Penolakan',
          inputPlaceholder: 'Masukkan alasan penolakan...',
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>pnt_pembetulan_verif/tolak_kelengkapan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,

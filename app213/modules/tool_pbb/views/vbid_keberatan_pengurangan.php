            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">KOORDINATOR BIDANG KEBERATAN - PENGURANGAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Koord Bidang Keberatan - Pengurangan</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>bid_keberatan_pengurangan/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("bid_keberatan_pengurangan/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == 'A' ) {
            window.location = '<?php echo active_module_url("bid_keberatan_pengurangan/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        ...
        var url = '<?php echo active_module_url(); ?>bid_keberatan_pengurangan/cetak_sk_tolak/' + id;
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
            ...
            "aoColumnDefs": [
                ...
                { "aTargets": [9], "bSearchable": false,  "bVisible": true,  "sWidth": "125px", "sClass": "",
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>bid_keberatan_pengurangan/grid"
        });

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">SIMULASI SPPT DAFNOM</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Simulasi SPPT DAFNOM</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.ajax.url("<?php echo active_module_url();?>simulasi_sppt_dafnom/grid/?"+data_params).load();
    }

    function f_dtl(nopthn) {
        var url = '<?php echo active_module_url("simulasi_sppt_dafnom/detail"); ?>'+nopthn;
        // window.location = '<?php //echo active_module_url("simulasi_sppt_dafnom/"); ?>'+nopthn;
    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
            ...
            "aoColumnDefs": [
                ...
                { "aTargets": [10], "bSearchable": false,  "bVisible": true,  "sWidth": "", "sClass": "",
                    "mRender": function( data, type, full) {
                        var dat = full[10].replace(/\./g, '');
                        return '<button class="btn btn-danger" onclick="f_dtl(\''+dat+'\')" type="button">Detail</button>';
                    }
                },
            ],
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>simulasi_sppt_dafnom/grid"
        });

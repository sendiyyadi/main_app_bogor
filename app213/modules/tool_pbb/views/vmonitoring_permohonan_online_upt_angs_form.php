            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">PERMOHONAN PELAYANAN UPT - ANGSURAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Permohonan Pelayanan UPT Angsuran</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12 ">
                                          ...
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>APPROVE LOKET</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_apr_loket">NIP APPROVE LOKET</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_apr_loket">NAMA APPROVE LOKET</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_apr_loket">TANGGAL APPROVE LOKET</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>VERIFIKASI PENDANIL</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_ver_pdl">NIP VERIFIKASI PENDANIL</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_ver_pdl">NAMA VERIFIKASI PENDANIL</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_ver_pdl">TANGGAL VERIFIKASI PENDANIL</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>KEPALA SUB BIDANG PENDANIL</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_subid_pdl">NIP KEPALA SUB BIDANG PENDANIL</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_subid_pdl">NAMA KEPALA SUB BIDANG PENDANIL</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_subid_pdl">TANGGAL KEPALA SUB BIDANG PENDANIL</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>KEPALA BIDANG PENDANIL</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_bid_pdl">NIP KEPALA BIDANG PENDANIL</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_bid_pdl">NAMA KEPALA BIDANG PENDANIL</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_bid_pdl">TANGGAL KEPALA BIDANG PENDANIL</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>KOORDINATOR PKP</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_koor_pkp">NIP KOORDINATOR PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_koor_pkp">NAMA KOORDINATOR PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_koor_pkp">TANGGAL KOORDINATOR PKP</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>VERIFIKASI PKP</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_ver_pkp">NIP VERIFIKASI PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_ver_pkp">NAMA VERIFIKASI PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_ver_pkp">TANGGAL VERIFIKASI PKP</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>KEPALA SUB BIDANG PKP</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_subid_pkp">NIP KEPALA SUB BIDANG PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_subid_pkp">NAMA KEPALA SUB BIDANG PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_subid_pkp">TANGGAL KEPALA SUB BIDANG PKP</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>KEPALA BIDANG PKP</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_bid_pkp">NIP KEPALA BIDANG PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_bid_pkp">NAMA KEPALA BIDANG PKP</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_bid_pkp">TANGGAL KEPALA BIDANG PKP</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>VERIFIKASI PENETAPAN</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_ver_pntp">NIP VERIFIKASI PENETAPAN</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_ver_pntp">NAMA VERIFIKASI PENETAPAN</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_ver_pntp">TANGGAL VERIFIKASI PENETAPAN</label><br>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-2 d-flex align-items-center" style="padding-left:20px;">
                                                  <label>KEPALA PENETAPAN</label>
                                              </div>
                                              <div class="col-md-3">
                                                <label for="nip_bid_pntp">NIP KEPALA PENETAPAN</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_bid_pntp">NAMA KEPALA PENETAPAN</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_bid_pntp">TANGGAL KEPALA PENETAPAN</label><br>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label font-weight-bold">1.</label>
                                                                <div class="col-sm-10">
                                                                    <label>Jatuh Tempo</label>
                                                                    <input type="date" name="jatuh_tempo_1" id="jatuh_tempo_1" class="form-control" value="<?php echo $dt['jatuh_tempo_1']?>">

                                                                    <label class="mt-2">Nominal</label>
                                                                    <input type="text" name="nominal_1" id="nominal_1" class="form-control" value="<?php echo $dt['nominal_1']?>">
                                                                </div>
                                                            </div>

                                                            <!-- Angsuran 2 -->
                                                            <div class="form-group row" style="margin-top:10px;">
                                                                <label class="col-sm-2 col-form-label font-weight-bold">2.</label>
                                                                <div class="col-sm-10">
                                                                    <label>Jatuh Tempo</label>
                                                                    <input type="date" name="jatuh_tempo_2" id="jatuh_tempo_2" class="form-control" value="<?php echo $dt['jatuh_tempo_2']?>">

                                                                    <label class="mt-2">Nominal</label>
                                                                    <input type="text" name="nominal_2" id="nominal_2" class="form-control" value="<?php echo $dt['nominal_2']?>">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <!-- Angsuran 3 -->
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label font-weight-bold">3.</label>
                                                                <div class="col-sm-10">
                                                                    <label>Jatuh Tempo</label>
                                                                    <input type="date" name="jatuh_tempo_3" id="jatuh_tempo_3" class="form-control" value="<?php echo $dt['jatuh_tempo_3']?>">

                                                                    <label class="mt-2">Nominal</label>
                                                                    <input type="text" name="nominal_3" id="nominal_3" class="form-control" value="<?php echo $dt['nominal_3']?>">
                                                                </div>
                                                            </div>

                                                            <!-- Angsuran 4 -->
                                                            <div class="form-group row" style="margin-top:10px;">
                                                                <label class="col-sm-2 col-form-label font-weight-bold">4.</label>
                                                                <div class="col-sm-10">
                                                                    <label>Jatuh Tempo</label>
                                                                    <input type="date" name="jatuh_tempo_4" id="jatuh_tempo_4" class="form-control" value="<?php echo $dt['jatuh_tempo_4']?>">

                                                                    <label class="mt-2">Nominal</label>
                                                                    <input type="text" name="nominal_4" id="nominal_4" class="form-control" value="<?php echo $dt['nominal_4']?>">
                                                                </div>
                                                            </div>

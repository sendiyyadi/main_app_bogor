            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">PERMOHONAN ONLINE UPT PENGURANGAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Permohonan Online UPT Pengurangan</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            <div class="row">
                                              ...
                                              <div class="col-md-3">
                                                <label for="nip_ver_pdl">NIP VERIFIKASI</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="nama_ver_pdl">NAMA VERIFIKASI</label><br>
                                              ...
                                              <div class="col-md-3">
                                                <label for="tgl_ver_pdl">TANGGAL VERIFIKASI</label><br>
                                    ...
                                    <div id="row_bawah" class="">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-6" style="align-self:start;">
                                          ...
                                          <div class="row mt-2" id="r_subjns">
                                            <div class="col-md-4" style="padding-left:20px;">

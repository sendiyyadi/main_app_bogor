                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">Tgl Verif Penetapan</span>
                                    </div>
                                    <div class="controls">
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pnt_pembetulan/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pnt_pembetulan/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == 'B') {
            window.location = '<?php echo active_module_url("pnt_pembetulan/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        ...
        var url = '<?php echo active_module_url(); ?>pnt_pembetulan/cetak_sk/' + id;
    ...
    function f_ctk_sk(id, sts) {
        var url = '<?php echo active_module_url(); ?>pnt_pembetulan/cetak_draft_sk/' + id;
        var winparams = 'width=' + screen.width + ',height=' + screen.height + ',directories=0,titlebar=0,toolbar=0,location=0,status=0,menubar=0,scrollbars=no,resizable=no';
        window.open(url, 'SK Pembetulan', winparams);
    }
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
                            ...
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="javascript:void(0)" onclick="f_ctk('${full[0]}', '${full[11]}')">
                                        <i class="fas fa-file-excel mr-2"></i> Cetak SK
                                    </a>
                                    <a class="dropdown-item" href="javascript:void(0)" onclick="f_ctk_sk('${full[0]}', '${full[11]}')">
                                        <i class="fas fa-file-alt mr-2"></i> Cetak Draft SK
                                    </a>
                                </div>
                            </div>
                            `;
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pnt_pembetulan/grid"
        });

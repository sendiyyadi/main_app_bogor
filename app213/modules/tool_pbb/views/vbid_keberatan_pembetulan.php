                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">Tgl Ver PKP</span>
                                    </div>
                                    <div class="controls">
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>bid_keberatan_pembetulan/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("bid_keberatan_pembetulan/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == 'A' || sts == 'C' ) {
            window.location = '<?php echo active_module_url("bid_keberatan_pembetulan/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        ...
        var url = '<?php echo active_module_url(); ?>bid_keberatan_pembetulan/cetak_sk_tolak/' + id;
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>bid_keberatan_pembetulan/grid"
        });

...
#table1 tr:hover {background-color: #ffa;} 
#table1 th {
    padding-top: 12px;
    padding-bottom: 12px;
    text-align: center;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">VERIFIKASI MUTASI HABIS</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-bordered mt-2" id="table1">
                                <thead>
                                <tr>
                                    <th>id</th>
                                    <th>NO PLY</th>
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pdl_mutasi_habis/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pdl_mutasi_habis/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == '4') {
            window.location = '<?php echo active_module_url("pdl_mutasi_habis/edit"); ?>'+id;
        } else {
            alert('Tidak bisa edit data. Status dokumen bukan Approve Loket'); return false;
        }
    }
    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pdl_mutasi_habis/grid"
        });

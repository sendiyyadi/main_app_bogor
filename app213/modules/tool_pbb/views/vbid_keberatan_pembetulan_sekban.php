                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">Tgl Apr Kabid PKP</span>
                                    </div>
                                    <div class="controls">
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>bid_keberatan_pembetulan_sekban/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("bid_keberatan_pembetulan_sekban/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == 'J' ) {
            window.location = '<?php echo active_module_url("bid_keberatan_pembetulan_sekban/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        ...
        var url = '<?php echo active_module_url(); ?>bid_keberatan_pembetulan_sekban/cetak_sk_tolak/' + id;
    ...
    function f_ctk_penelitian(id, sts) {
        if(sts == '4') {
            ...
            var url = '<?php echo active_module_url(); ?>bid_keberatan_pembetulan_sekban/cetak_analisa_pembetulan/' + id;
            var winparams = 'width=' + screen.width + ',height=' + screen.height + ',directories=0,titlebar=0,toolbar=0,location=0,status=0,menubar=0,scrollbars=no,resizable=no';
    ...
    function f_ctk_sk(id, sts) {
        var url = '<?php echo active_module_url(); ?>bid_keberatan_pembetulan_sekban/cetak_draft_sk/' + id;
        var winparams = 'width=' + screen.width + ',height=' + screen.height + ',directories=0,titlebar=0,toolbar=0,location=0,status=0,menubar=0,scrollbars=no,resizable=no';
        window.open(url, 'SK Pembetulan', winparams);
    }
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>bid_keberatan_pembetulan_sekban/grid"
        });

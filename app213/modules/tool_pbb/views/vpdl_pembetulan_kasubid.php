                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">Tgl Apr Verif PDL</span>
                                    </div>
                                    <div class="controls">
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pdl_pembetulan_kasubid/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pdl_pembetulan_kasubid/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == '6' || sts == 'C') {
            window.location = '<?php echo active_module_url("pdl_pembetulan_kasubid/edit"); ?>'+id;
        } else {
            alert('Tidak bisa edit data. Status dokumen bukan Approve Verifikasi Pdl'); return false;
        }
    }
    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pdl_pembetulan_kasubid/grid"
        });

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">KABID PENDANIL PEMBETULAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Kabid Pendanil Pembetulan</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">Tgl Apr Kasubid PDL</span>
                                    </div>
                                    <div class="controls">
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pdl_pembetulan_kabid/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pdl_pembetulan_kabid/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == '7') {
            window.location = '<?php echo active_module_url("pdl_pembetulan_kabid/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        if(sts == '4') {
            ...
            var url = '<?php echo active_module_url(); ?>pdl_pembetulan/cetak_analisa_pembetulan/' + id;
    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
            ...
            "aoColumnDefs": [
                ...
                { "aTargets": [10], "bSearchable": false,  "bVisible": true,  "sWidth": "70px", "sClass": "",
                    "mRender": function( data, type, full) {
                        ...
                        // var edt = '<button class="btn btn-danger rounded-circle me-1" onclick="f_edit(\''+full[0]+'\', \''+full[9]+'\')" data-toggle="tooltip" data-placement="top" title="Action" type="button"><i class="fas fa-pencil-alt"></i></button>';
                        ...
                        // var dtl = '<button class="btn btn-warning rounded-circle me-1" onclick="f_dtl(\''+full[0]+'\')" type="button" style="margin-left:5px">Detail</button>';
                        return edt + dtl + ctk;
                    }
                },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pdl_pembetulan_kabid/grid"
        });

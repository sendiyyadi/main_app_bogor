            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">APPROVE SEKRETARIS BADAN - BIDANG KEBERATAN - PEMBETULAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Appr Sekban Bidang Keberatan - Pembetulan</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12 ">
                                      ...
                                      <div id="row_bawah" class="">
                                        ...
                                        <div class="row" style="margin-top:40px">
                                          <div class="col-md-12">
                                            <?php if ($this->uri->segment(3) != 'detail') { ?>
                                              <?php if ($dt['sts_permo'] == 'J') { ?>
                                              <button class="btn btn-success" id="btn_batal" type="submit">APPROVE SEKBAN</button>
                                              <button class="btn btn-warning" id="btn_tolak_ply" type="button" >PENELITIAN ULANG</button>
                                              <button class="btn btn-danger" id="btn_tolak_ke_ver_pkp" type="button" >TOLAK KE VERIF KEBERATAN</button>
                                              <?php } ?>
                                            <?php } ?>
...
function f_hapus_detail(id_dob) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('bid_keberatan_pembetulan_sekban'); ?>delete_dtl_bng/' + id_dob,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
function f_hapus_detail_fas(id_fas) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('bid_keberatan_pembetulan_sekban'); ?>delete_dtl_fas_bng/' + id_fas,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
$(document).ready(function() {
  ...
  $('#myform').on('submit', function(e) {
      ...
      $.ajax({
          url: "<?php echo active_module_url() ?>bid_keberatan_pembetulan_sekban/approve_permohonan/",
          type: 'POST',
          data: data,
          processData: false,
          contentType: false,
          ...
          success: function(res) {
              ...
              if (res.result == 400) {
                  ...
                  Swal.fire({
                      ...
                      window.location = '<?php echo active_module_url("bid_keberatan_pembetulan_sekban"); ?>';
                  });
              }
          },
          complete: function () {
  ...
  $('#btn_tolak').on('click', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "<?php echo active_module_url() ?>bid_keberatan_pembetulan_sekban/tolak_permohonan/",
                type: 'POST',
                data: data,
                processData: false,
                contentType: false,
  ...
  $('#btn_save_dsp').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_sekban/save_data_subjek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
  ...
  $('#btn_save_dop').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_sekban/save_data_objek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
  ...
  $('#btn_hitung_njop_bng').click(function(e) {
    ...
    $.ajax({
        url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_sekban/hitung_njop_bng/',
        type: "POST",    
        data: {
          id_ppo: id_ppo,
          paramm: paramm,
        ...
        success: function(response) {
            ...
            $.ajax({
                url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_sekban/get_data_pembanding/',
                type: "POST",    
                data: {
                  id_ppo: id_ppo,
                },
  ...
  $('#btn_hitung_njop_bumi').click(function(e) {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/bid_keberatan_pembetulan_sekban/hitung_njop_bumi/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            luas_bumi: luas_bumi,
  ...
  $('#btn_tolak_ply').on('click', function () {
      ...
      Swal.fire({
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>bid_keberatan_pembetulan_sekban/tolak_ke_pelayanan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,
  ...
  $('#btn_tolak_ke_ver_pkp').on('click', function () {

      Swal.fire({
          title: 'Tolak Berkas?',
          text: 'Tolak Berkas ini dan kembalikan ke Verifikasi Keberatan?',
          icon: 'warning',
          input: 'textarea',
          inputLabel: 'Keterangan Penolakan',
          inputPlaceholder: 'Masukkan alasan penolakan...',
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>bid_keberatan_pembetulan_kasubid/tolak_ke_ver_pkp/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,
          ...
          if (result.isConfirmed) {
              Swal.fire({
                  ...
                  window.location = '<?php echo active_module_url("bid_keberatan_pembetulan_kasubid"); ?>';
              });
          }
      });
  });

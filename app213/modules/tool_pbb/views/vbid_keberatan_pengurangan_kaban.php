            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">KABAN - PENGURANGAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Kaban - Pengurangan</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">Tgl Apr Sekban</span>
                                    </div>
                                    <div class="controls">
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>bid_keberatan_pengurangan_kaban/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("bid_keberatan_pengurangan_kaban/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == 'I' ) {
            window.location = '<?php echo active_module_url("bid_keberatan_pengurangan_kaban/edit"); ?>'+id;
        } else {
    ...
    function f_ctk(id, sts) {
        ...
        var url = '<?php echo active_module_url(); ?>bid_keberatan_pengurangan_kaban/cetak_sk_tolak/' + id;
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>bid_keberatan_pengurangan_kaban/grid"
        });

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">LOKET PERMOHONAN ONLINE UPT</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Loket Permohonan Online UPT</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row" style="display:none;">
                                          <div class="col-md-4">
                                            <div class="row">
                                              ...
                                              <div class="col-md-7">
                                                <div id="r_ktp_re_1" >  
                                                  <a target="_blank" href="<?php echo active_module_url().'loket_permohonan_online_upt/openblob_reg_esppt/IM_KTP_BLOB/'.$dt['nop_re'].'/'.$dt['nik_re']; ?>" class="btn btn-primary " data-toggle="tooltip" title="File KTP"></i> Lihat File</a>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-md-4">
                                            <div class="row">
                                              ...
                                              <div class="col-md-7">
                                                <div id="r_sppt_re_1" >  
                                                  <a target="_blank" href="<?php echo active_module_url().'loket_permohonan_online_upt/openblob_reg_esppt/IM_SPPT_BLOB/'.$dt['nop_re'].'/'.$dt['nik_re']; ?>" class="btn btn-primary " data-toggle="tooltip" title="File SPPT"></i> Lihat File</a>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-md-4">
                                            <div class="row">
                                              ...
                                              <div class="col-md-7">
                                                <div id="r_stts_re_1" >  
                                                  <a target="_blank" href="<?php echo active_module_url().'loket_permohonan_online_upt/openblob_reg_esppt/IM_PBB_BLOB/'.$dt['nop_re'].'/'.$dt['nik_re']; ?>" class="btn btn-primary " data-toggle="tooltip" title="File STTS"></i> Lihat File</a>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                      ...
                                      <div id="row_bawah" class="">
                                        ...
                                        <div class="row" style="margin-top:20px">
                                          <div class="col-md-12">
                                            ...
                                            <button class="btn btn-warning" id="btn_tolak" type="button">Tolak Pelayanan</button>
                                            <button class="btn btn-warning" id="btn_tolak_kelengkapan" type="button">Tolak Kelengkapan Data</button>
                                            <?php } ?>
                                            <?php if ($dt['kd_jns_ply'] == '03' &&  $dt['kd_sub_jns_ply'] == '02' ) { ?>
                                              <button class="btn btn-secondary" id="btn_kirim_pkp" type="button">Kirim Berkas Ke PKP</button>
                                            <?php } ?>
...
function reload_grid_detail() {
  oTable.fnReloadAjax("<?php echo active_module_url('loket_permohonan_online_upt/grid_dtl_bng_ol').$dt['rowid'].'?iDisplayLength=50'; ?>");
}

function reload_grid_detail_fasilitas(id_head) {
  oTable2.fnReloadAjax("<?php echo active_module_url('loket_permohonan_online_upt/grid_dtl_fas_ol'); ?>" + id_head);
}
...
function f_view_detail(id_dob) {
    $.ajax({
      url: '<?php echo active_module_url('loket_permohonan_online_upt'); ?>/get_dtl_bng/' + id_dob,
      async: false,
      success: function (j) {
...
$(document).ready(function() {
  ...
  oTable = $('#tableKD').dataTable({
    ...
    "sAjaxSource": "<?php echo active_module_url('loket_permohonan_online_upt/grid_dtl_bng_ol').$dt['rowid'].'?iDisplayLength=50';?>"
  });
  ...
  $('#btn_kirim_pkp').on('click', function(e) {
    e.preventDefault();
    Swal.fire({
        icon: "info",
        title: "Peringatan",
        text: 'Kirim ke PKP Data Permohonan Ini?',
        confirmButtonText: "Approve",
        cancelButtonText: "Batal",
        showCancelButton: true
    }).then((result) => {
        if (result.isConfirmed) {
            ...
            $('#myform').attr('action', "<?php echo active_module_url('loket_permohonan_online_upt/kirim_ke_pkp') ?>").submit();
        }
    });
  ...
  $('#btn_tolak').on('click', function(e) {
    ...
    if (!ket || ket.trim() === '') {
        ...
        Swal.fire({
            icon: "warning",
            title: "Peringatan",
            text: 'Tolak Pelayanan Data Permohonan Ini?',
  ...
  $('#btn_tolak_kelengkapan').on('click', function(e) {
    e.preventDefault();
    var ket = $('#ket_pst').val();
    if (!ket || ket.trim() === '') {
        Swal.fire({
        ...
        Swal.fire({
            icon: "warning",
            title: "Peringatan",
            text: 'Tolak Kelengkapan Data Permohonan Ini?',
            confirmButtonText: "Tolak",
            cancelButtonText: "Batal",
            showCancelButton: true
        }).then((result) => {
            if (result.isConfirmed) {
                $('#myform').attr('action', "<?php echo active_module_url('loket_permohonan_online_upt/tolak_kelengkapan') ?>").submit();
            }
        });
    }

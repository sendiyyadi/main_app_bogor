            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0"><?php if ($this->uri->segment(3) == 'detail') echo 'DETAIL '; ?>VERIFIKASI MUTASI HABIS</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Verifikasi Mutasi Habis</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                  ...
                                  <div class="row" style="margin-right:0px; margin-left:0px; background-image:url(<?php echo site_url('assets/img/stadion_pakansari.jpg'); ?>);
                                    ...
                                    <div class="col-md-12 ">
                                      ...
                                      <div id="row_bawah" class="">
                                        ...
                                        <div class="row mt-4">
                                          <div class="col-md-3">
                                            <label for="tahun_awal">TAHUN AWAL MUTASI HABIS</label><br>
                                          ...
                                          <div class="col-md-3">
                                            <label for="tahun_akhir">TAHUN AKHIR MUTASI HABIS</label><br>
                                        ...
                                        <div class="row mt-4">
                                          <div class="col-md-12">
                                            <label for="alasan_tlk">ALASAN TOLAK BERKAS</label><br>
                                            <input class="form-control" type="text" id="alasan_tlk" name="alasan_tlk" maxlength="4" autocomplete="off" value="<?php echo $dt['alasan_tlk']?>" >
                                          </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top:40px">
                                          <div class="col-md-12">
                                            <?php if ($this->uri->segment(3) == 'edit') { ?>
                                              <button class="btn btn-success" id="btn_batal" type="submit" disabled>APPROVE PERMOHONAN</button>
                                              <button class="btn btn-warning" id="btn_tolak" type="button" >TOLAK PELAYANAN</button>
                                              <button class="btn btn-warning" id="btn_tolak_ply" type="button" >TOLAK KELENGKAPAN BERKAS</button>
                                            <?php } ?>
...
function f_hapus_detail(id_dob) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('pdl_mutasi_habis'); ?>delete_dtl_bng/' + id_dob,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
function f_hapus_detail_fas(id_fas) {
    ...
    if (hapus == true) {
        $.ajax({
          url: '<?php echo active_module_url('pdl_mutasi_habis'); ?>delete_dtl_fas_bng/' + id_fas,
          async: false,
          success: function (j) {
            // var data = $.parseJSON(j);
            alert(j);
...
$(document).ready(function() {
  ...
  $('#myform').on('submit', function(e) {
      ...
      $.ajax({
          url: "<?php echo active_module_url() ?>pdl_mutasi_habis/approve_permohonan/",
          type: 'POST',
          data: data,
          processData: false,
          contentType: false,
          ...
          success: function(res) {
              ...
              if (res.result == 400) {
                  ...
                  Swal.fire({
                      ...
                      window.location = '<?php echo active_module_url("pdl_mutasi_habis"); ?>';
                  });
              }
          },
          complete: function () {
  ...
  $('#btn_save_dsp').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/pdl_mutasi_habis/save_data_subjek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
  ...
  $('#btn_save_dop').click(function() {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/pdl_mutasi_habis/save_data_objek_pajak/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            ktp_wp: ktp_wp,
  ...
  $('#btn_hitung_njop_bng').click(function(e) {
    ...
    $.ajax({
        url: '<?php echo active_module_url(); ?>/pdl_mutasi_habis/hitung_njop_bng/',
        type: "POST",    
        data: {
          id_ppo: id_ppo,
          paramm: paramm,
  ...
  $('#btn_hitung_njop_bumi').click(function(e) {
      ...
      $.ajax({
          url: '<?php echo active_module_url(); ?>/pdl_mutasi_habis/hitung_njop_bumi/',
          type: "POST",    
          data: {
            id_ppo: id_ppo,
            luas_bumi: luas_bumi,
  ...
  $('#btn_tolak_ply').on('click', function () {
      ...
      Swal.fire({
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>pdl_mutasi_habis/tolak_ke_pelayanan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,
  ...
  $('#btn_tolak').on('click', function () {
      ...
      Swal.fire({
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>pdl_mutasi_habis/tolak_permohonan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,

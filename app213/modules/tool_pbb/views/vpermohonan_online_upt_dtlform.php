...
$(document).ready(function() {
  ...
  oTable = $('#tableKD').dataTable({
    ...
    "aoColumnDefs": [
        ...
        { "aTargets": [7], "bSearchable": true,  "bVisible": <?php echo $this->uri->segment(3) == 'changenop' ? 'true' : 'false' ; ?>, "sWidth": "100px", "sClass": "center", 
            "mRender": function ( source, type, val ) {
  ...
  oTable2 = $('#tableKDFas').dataTable({
    ...
    "aoColumnDefs": [
        ...
        { "aTargets": [5], "bSearchable": true,  "bVisible": <?php echo $this->uri->segment(3) == 'changenop' ? 'true' : 'false' ; ?>, "sWidth": "100px", "sClass": "center", 
            "mRender": function ( source, type, val ) {
  ...
  $('#btn_send_permo').on('click', function() {
    window.location = '<?php echo active_module_url("monitoring_permo_upt"); ?>';
  });
...
<div class="content">
  <div class="container-fluid">
    <ul class="nav nav-tabs" id="myTab">
      <li class="active"><a href="#"><strong>DETAIL PERMOHONAN ONLINE UPT</strong></a></li>
    </ul>
            ...
            <div class="col-md-12 ">
              ...
              <div id="row_bawah" class="">
                ...
                <div class="row" style="margin-top:40px">
                  <div class="col-md-6">
                    <button class="btn btn-success" id="btn_back" type="button">Kembali</button>
                  </div>
                </div>
                <!-- </form> -->
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <?php if ($this->uri->segment(3) == 'changenop') : ?>

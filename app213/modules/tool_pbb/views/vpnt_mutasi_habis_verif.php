            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">VERIFIKASI PENETAPAN MUTASI HABIS</h4>
                            ...
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="input-group w-auto">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text rounded-end-0">Tgl Apr Verifikasi</span>
                                    </div>
                                    <div class="controls">
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pnt_mutasi_habis_verif/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pnt_mutasi_habis_verif/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        // if(sts == 'A') {
        if(sts == 'H') {
            window.location = '<?php echo active_module_url("pnt_mutasi_habis_verif/edit"); ?>'+id;
        } else {
            alert('Tidak bisa edit data. Status dokumen bukan Approve Pendanil'); return false;
        }
    }
    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
            ...
            "aoColumnDefs": [
                ...
                { "aTargets": [10], "bSearchable": false,  "bVisible": true,  "sWidth": "", "sClass": "",
                    "mRender": function( data, type, full) {
                        var edt = '<button class="btn btn-danger" onclick="f_edit(\''+full[0]+'\', \''+full[11]+'\')" type="button">Action</button>';
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pnt_mutasi_habis_verif/grid"
        });

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">KOORDINATOR BIDANG KEBERATAN - PELAYANAN PENGURANGAN</h4>
                        <div class="page-title-right" id="test">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Tool PBB</a>
                                </li>
                                <li class="breadcrumb-item active">Koord Bidang Keberatan - Pelayanan Pengurangan</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
  ...
  $('#btn_back').on('click', function() {
    window.location = '<?php echo active_module_url("bid_keberatan_pengurangan"); ?>';
  }); 
  ...
  $('#myform').on('submit', function(e) {
      ...
      $.ajax({
          url: "<?php echo active_module_url() ?>bid_keberatan_pengurangan/approve_permohonan/",
          type: 'POST',
          data: data,
          processData: false,
          contentType: false,
  ...
  $('#btn_tolak').on('click', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "<?php echo active_module_url() ?>bid_keberatan_pengurangan/tolak_permohonan/",
                type: 'POST',
                data: data,
                processData: false,
                contentType: false,
  ...
  $('#btn_tolak_ply').on('click', function () {
      ...
      Swal.fire({
          ...
          preConfirm: (ket_tolak_ply) => {
              ...
              return $.ajax({
                  url: '<?php echo active_module_url() ?>bid_keberatan_pengurangan/tolak_ke_pelayanan/',
                  type: 'POST',
                  dataType: 'text',
                  data: {
                      id_ppo: id_ppo,

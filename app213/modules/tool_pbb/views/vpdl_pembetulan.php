...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pdl_pembetulan/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pdl_pembetulan/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        if(sts == '4') {
            window.location = '<?php echo active_module_url("pdl_pembetulan/edit"); ?>'+id;
        } else {
    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
            ...
            "aoColumnDefs": [
                ...
                { "aTargets": [10], "bSearchable": false,  "bVisible": true,  "sWidth": "120px", "sClass": "",
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pdl_pembetulan/grid"
        });

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">PENETAPAN MUTASI HABIS</h4>
...
<script>
    ...
    function reload_grid() {
        ...
        oTable.fnReloadAjax("<?php echo active_module_url();?>pnt_mutasi_habis/grid/?"+data_params);
    }

    function f_dtl(id) {
        window.location = '<?php echo active_module_url("pnt_mutasi_habis/detail"); ?>'+id;
    }

    function f_edit(id, sts) {
        // if(sts == 'A') {
        if(sts == 'B') {
            window.location = '<?php echo active_module_url("pnt_mutasi_habis/edit"); ?>'+id;
        } else {
    ...
    $(document).ready(function() {
        oTable = $('#table1').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo active_module_url();?>pnt_mutasi_habis/grid"
        });

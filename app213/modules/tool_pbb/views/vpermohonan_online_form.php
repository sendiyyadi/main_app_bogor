                                ...
                                <div class="row" style="margin-right:0px; margin-left:0px; background-image:url(<?php echo site_url('assets/img/stadion_pakansari.jpg'); ?>);
                                  ...
                                  <div class="col-md-12 ">
                                      ...
                                      <div class="row" style="margin-top:40px">
                                        <div class="col-md-6 hidden" id="row_re_1">
                                          <button class="btn btn-success" id="btn_send_re" type="button">Kirim Email</button>
                                        </div>
                                        <div class="col-md-6 hidden" id="row_re_2">
                                          <button class="btn btn-success" id="btn_save_re" type="button">Simpan dan Kirim Email</button>
                                        </div>
                                      </div>
                                      <!-- </form> -->
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                              <input class="form-control" type="text" id="nop" name="nop" autocomplete="off" value="<?php echo $dt['nop']?>" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_spop" name="im_spop" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_lspop" name="im_lspop" >
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_ktp" name="im_ktp" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_sertanah" name="im_sertanah" >
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_imb" name="im_imb" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_foto_op" name="im_foto_op" >
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_valbphtb" name="im_valbphtb" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_pengantar_desa" name="im_pengantar_desa" >
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_nonsengketa" name="im_nonsengketa" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_riwyt_tanah" name="im_riwyt_tanah" >
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_sppt" name="im_sppt" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_stts" name="im_stts" >
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_sk_pengurangan" name="im_sk_pengurangan" >
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row">
                                            ...
                                            <div class="col-md-7">
                                            <input style="width:100%; height:100% !important;" type="file" id="im_other" name="im_other" >
                                            </div>
                                          </div>
                                        </div>
                                      </div>
...
function f_chg_div_lamp_regesppt(nop, nik) {
  ...
  div_ktp.innerHTML = '<a target="_blank" href="<?php echo active_module_url().'permohonan_online/openblob_reg_esppt/IM_KTP_BLOB/'; ?>'+nop+'/'+nik+'" class="btn btn-primary " data-toggle="tooltip" title="File KTP"></i> Lihat File</a>';
  ...
  div_sppt.innerHTML = '<a target="_blank" href="<?php echo active_module_url().'permohonan_online/openblob_reg_esppt/IM_SPPT_BLOB/'; ?>'+nop+'/'+nik+'" class="btn btn-primary " data-toggle="tooltip" title="File SPPT"></i> Lihat File</a>';
  ...
  div_stts.innerHTML = '<a target="_blank" href="<?php echo active_module_url().'permohonan_online/openblob_reg_esppt/IM_PBB_BLOB/'; ?>'+nop+'/'+nik+'" class="btn btn-primary " data-toggle="tooltip" title="File STTS"></i> Lihat File</a>';
...
function f_btn_cari_nop(nop){
  $.ajax({
      url: "<?php echo active_module_url() ?>permohonan_online/get_nop_reg_esppt/" + nop,
      async: true,
      success: function(j) {
        // setTimeout(function(){
        //   $("#overlay").fadeOut(100);
...
$(document).ready(function() {
  ...
  $("#btn_send_re").click(function () {//The load button
      ...
      $("#overlay").fadeIn(300);
      $.ajax({
        url: "<?php echo active_module_url() ?>permohonan_online/send_mail_reg_esppt/" + nopnik,
        success: function(j) {
          var data = $.parseJSON(j);
          alert(data['msg']);
        },
  ...
  $('#btn_save_re').on('click', function() {
    ...
    $.ajax({
      url: "<?php echo active_module_url() ?>permohonan_online/save_reg_esppt/",
      type: 'POST',
      data: data,
      processData: false,
      contentType: false,
  ...
  $('#btn_send_permo').on('click', function() {
    ...
    $.ajax({
      url: "<?php echo active_module_url() ?>permohonan_online/save_permo/",
      type: 'POST',
      data: data,
      processData: false,
      contentType: false,
  ...
  $('#btn_dtl_simpan').on('click', function() {
    ...
    $.ajax({
      url: "<?php echo active_module_url() ?>permohonan_online/appr_permo/"+nop+"/"+thn_ply+"/"+kd_ply,
      type: 'POST',
      success: function(j) {
        var data = $.parseJSON(j);
        alert(data['msg']);
  ...
  //   var nop = $('#nop_re').val();
  //   $.ajax({
  //     url: "<?php //echo active_module_url() ?>permohonan_online/save_reg_esppt/" + nop,
  //     async: false,
  //     success: function(j) {
  //       var data = $.parseJSON(j);
